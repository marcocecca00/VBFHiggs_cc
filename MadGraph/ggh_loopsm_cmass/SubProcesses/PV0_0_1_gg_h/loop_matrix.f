...
C     
C     Process: g g > h WEIGHTED<=4 [ noborn = QCD ]
C     
C     Modules
C     
...
C     
 ...
 1009   CONTINUE
     ...
     $ //' ML5_0_0_1_ML5SOINDEX_FOR_SQUARED_ORDERS'
      ...
      INTEGER FUNCTION ML5_0_0_1_GETORDPOWFROMINDEX_ML5(IORDER, INDX)
C     
...
C     
      ...
      ML5_0_0_1_GETORDPOWFROMINDEX_ML5=SQPLITORDERS(INDX, IORDER)
...
C     
      ...
      DATA (LOOPAMPORDERS(I),I=  6,  9) /    1,    1,    1,    1/
C     -----------
C     BEGIN CODE
C     -----------
