...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MC,+1,+1*IC(1),W(1,1))  !  count 208
      CALL IXXXXX(P(0,1),MDL_MC,-1,+1*IC(1),W(1,2))  !  count 196
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,3))  !  count 208
      ...
      CALL FFS4_3(W(1,7),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,10))  !  count 68
      CALL FFS4_3(W(1,8),W(1,5),GC_84,MDL_MH,FK_MDL_WH,W(1,11))  !  count 68
      CALL FFS4_3(W(1,8),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,12))  !  count 72
      CALL OXXXXX(P(0,5),MDL_MC,+1,+1*IC(5),W(1,13))  !  count 196
      CALL OXXXXX(P(0,5),MDL_MC,-1,+1*IC(5),W(1,14))  !  count 208
      CALL IXXXXX(P(0,6),MDL_MC,+1,-1*IC(6),W(1,15))  !  count 196
      CALL IXXXXX(P(0,6),MDL_MC,-1,-1*IC(6),W(1,16))  !  count 208
      CALL FFS4_2(W(1,1),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,17))  !  count 48
      CALL FFS4_2(W(1,1),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,18))  !  count 48
      CALL FFS4_2(W(1,1),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,19))  !  count 48
      ...
      CALL FFV1P0_3(W(1,15),W(1,3),GC_2,ZERO,FK_ZERO,W(1,25))  !  count 32
      CALL FFV1P0_3(W(1,15),W(1,4),GC_2,ZERO,FK_ZERO,W(1,26))  !  count 28
      CALL FFV1P0_3(W(1,16),W(1,3),GC_2,ZERO,FK_ZERO,W(1,27))  !  count 32
      CALL FFV1P0_3(W(1,16),W(1,4),GC_2,ZERO,FK_ZERO,W(1,28))  !  count 32
      CALL FFV1P1N_1(W(1,13), W(1,25), GC_2, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,57,49,61,53/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,13), W(1,26), GC_2, TMP(1))
      call CombineAmp(6,
     & (/11,3,15,7,42,38/), 
     & (/17,18,19,20,21,24/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,13), W(1,27), GC_2, TMP(1))
      call CombineAmp(8,
     & (/28,20,32,24,58,50,62,54/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,13), W(1,28), GC_2, TMP(1))
      call CombineAmp(8,
     & (/12,4,16,8,43,35,46,39/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,14), W(1,25), GC_2, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,55,47,59,51/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,14), W(1,26), GC_2, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,40,33,44,36/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,14), W(1,27), GC_2, TMP(1))
      call CombineAmp(8,
     & (/26,18,30,22,56,48,60,52/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,14), W(1,28), GC_2, TMP(1))
      call CombineAmp(8,
     & (/10,2,14,6,41,34,45,37/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFS4_3(W(1,15),W(1,3),GC_84,MDL_MH,ZERO,W(1,29))  !  count 48
      CALL FFS4_3(W(1,15),W(1,4),GC_84,MDL_MH,ZERO,W(1,30))  !  count 42
      CALL FFS4_3(W(1,16),W(1,3),GC_84,MDL_MH,ZERO,W(1,31))  !  count 48
      CALL FFS4_3(W(1,16),W(1,4),GC_84,MDL_MH,ZERO,W(1,32))  !  count 48
      CALL FFS4P1N_1(W(1,13), W(1,29), GC_84, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,57,49,61,53/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,13), W(1,30), GC_84, TMP(1))
      call CombineAmp(6,
     & (/11,3,15,7,42,38/), 
     & (/17,18,19,20,21,24/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,13), W(1,31), GC_84, TMP(1))
      call CombineAmp(8,
     & (/28,20,32,24,58,50,62,54/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,13), W(1,32), GC_84, TMP(1))
      call CombineAmp(8,
     & (/12,4,16,8,43,35,46,39/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,14), W(1,29), GC_84, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,55,47,59,51/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,14), W(1,30), GC_84, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,40,33,44,36/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,14), W(1,31), GC_84, TMP(1))
      call CombineAmp(8,
     & (/26,18,30,22,56,48,60,52/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,14), W(1,32), GC_84, TMP(1))
      call CombineAmp(8,
     & (/10,2,14,6,41,34,45,37/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_3(W(1,15),W(1,3),GC_51,GC_58,MDL_MZ,ZERO,W(1,33))  !  count 48
      CALL FFV2_5_3(W(1,15),W(1,4),GC_51,GC_58,MDL_MZ,ZERO,W(1,34))  !  count 42
      CALL FFV2_5_3(W(1,16),W(1,3),GC_51,GC_58,MDL_MZ,ZERO,W(1,35))  !  count 48
      CALL FFV2_5_3(W(1,16),W(1,4),GC_51,GC_58,MDL_MZ,ZERO,W(1,36))  !  count 48
      CALL FFV2_5P1N_1(W(1,13), W(1,33), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,57,49,61,53/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,13), W(1,34), GC_51, GC_58, TMP(1))
      call CombineAmp(6,
     & (/11,3,15,7,42,38/), 
     & (/17,18,19,20,21,24/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,13), W(1,35), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/28,20,32,24,58,50,62,54/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,13), W(1,36), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/12,4,16,8,43,35,46,39/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,14), W(1,33), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,55,47,59,51/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,14), W(1,34), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,40,33,44,36/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,14), W(1,35), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/26,18,30,22,56,48,60,52/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,14), W(1,36), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/10,2,14,6,41,34,45,37/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV1P0_3(W(1,15),W(1,13),GC_2,ZERO,FK_ZERO,W(1,37))  !  count 28
      CALL FFV1P0_3(W(1,15),W(1,14),GC_2,ZERO,FK_ZERO,W(1,38))  !  count 32
      CALL FFV1P0_3(W(1,16),W(1,13),GC_2,ZERO,FK_ZERO,W(1,39))  !  count 32
      CALL FFV1P0_3(W(1,16),W(1,14),GC_2,ZERO,FK_ZERO,W(1,40))  !  count 32
      CALL FFV1P1N_1(W(1,3), W(1,37), GC_2, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,57,49,61,53/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_1(W(1,3), W(1,38), GC_2, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,55,47,59,51/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_1(W(1,3), W(1,39), GC_2, TMP(1))
      call CombineAmp(8,
     & (/28,20,32,24,58,50,62,54/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_1(W(1,3), W(1,40), GC_2, TMP(1))
      call CombineAmp(8,
     & (/26,18,30,22,56,48,60,52/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_1(W(1,4), W(1,37), GC_2, TMP(1))
      call CombineAmp(6,
     & (/11,3,15,7,42,38/), 
     & (/17,18,19,20,21,24/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_1(W(1,4), W(1,38), GC_2, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,40,33,44,36/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_1(W(1,4), W(1,39), GC_2, TMP(1))
      call CombineAmp(8,
     & (/12,4,16,8,43,35,46,39/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_1(W(1,4), W(1,40), GC_2, TMP(1))
      call CombineAmp(8,
     & (/10,2,14,6,41,34,45,37/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFS4_3(W(1,15),W(1,13),GC_84,MDL_MH,FK_MDL_WH,W(1,41))  !  count 42
      CALL FFS4_3(W(1,15),W(1,14),GC_84,MDL_MH,FK_MDL_WH,W(1,42))  !  count 48
      CALL FFS4_3(W(1,16),W(1,13),GC_84,MDL_MH,FK_MDL_WH,W(1,43))  !  count 48
      CALL FFS4_3(W(1,16),W(1,14),GC_84,MDL_MH,FK_MDL_WH,W(1,44))  !  count 48
      CALL FFS4P1N_1(W(1,3), W(1,41), GC_84, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,57,49,61,53/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,5))
      CALL FFS4P1N_1(W(1,3), W(1,42), GC_84, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,55,47,59,51/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,5))
      CALL FFS4P1N_1(W(1,3), W(1,43), GC_84, TMP(1))
      call CombineAmp(8,
     & (/28,20,32,24,58,50,62,54/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,5))
      CALL FFS4P1N_1(W(1,3), W(1,44), GC_84, TMP(1))
      call CombineAmp(8,
     & (/26,18,30,22,56,48,60,52/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,5))
      CALL FFS4P1N_1(W(1,4), W(1,41), GC_84, TMP(1))
      call CombineAmp(6,
     & (/11,3,15,7,42,38/), 
     & (/17,18,19,20,21,24/),
     & TMP, W, AMP(1,5))
      CALL FFS4P1N_1(W(1,4), W(1,42), GC_84, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,40,33,44,36/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,5))
      CALL FFS4P1N_1(W(1,4), W(1,43), GC_84, TMP(1))
      call CombineAmp(8,
     & (/12,4,16,8,43,35,46,39/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,5))
      CALL FFS4P1N_1(W(1,4), W(1,44), GC_84, TMP(1))
      call CombineAmp(8,
     & (/10,2,14,6,41,34,45,37/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,5))  !  count 1
      CALL FFV2_5_3(W(1,15),W(1,13),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,45)
     $)  !  count 42
      CALL FFV2_5_3(W(1,15),W(1,14),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,46)
     $)  !  count 48
      CALL FFV2_5_3(W(1,16),W(1,13),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,47)
     $)  !  count 48
      CALL FFV2_5_3(W(1,16),W(1,14),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,48)
     $)  !  count 48
      CALL FFV2_5P1N_1(W(1,3), W(1,45), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,57,49,61,53/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,6))
      CALL FFV2_5P1N_1(W(1,3), W(1,46), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,55,47,59,51/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,6))
      CALL FFV2_5P1N_1(W(1,3), W(1,47), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/28,20,32,24,58,50,62,54/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,6))
      CALL FFV2_5P1N_1(W(1,3), W(1,48), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/26,18,30,22,56,48,60,52/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,6))
      CALL FFV2_5P1N_1(W(1,4), W(1,45), GC_51, GC_58, TMP(1))
      call CombineAmp(6,
     & (/11,3,15,7,42,38/), 
     & (/17,18,19,20,21,24/),
     & TMP, W, AMP(1,6))
      CALL FFV2_5P1N_1(W(1,4), W(1,46), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,40,33,44,36/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,6))
      CALL FFV2_5P1N_1(W(1,4), W(1,47), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/12,4,16,8,43,35,46,39/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,6))
      CALL FFV2_5P1N_1(W(1,4), W(1,48), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/10,2,14,6,41,34,45,37/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,3),GC_2,ZERO,FK_ZERO,W(1,49))  !  count 32
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO,FK_ZERO,W(1,50))  !  count 32
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO,FK_ZERO,W(1,51))  !  count 32
      CALL FFV1P0_3(W(1,2),W(1,4),GC_2,ZERO,FK_ZERO,W(1,52))  !  count 28
      ...
      CALL FFS4_2(W(1,16),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,58))  !  count 48
      CALL FFS4_2(W(1,16),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,59))  !  count 48
      CALL FFS4_2(W(1,16),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,60))  !  count 48
      CALL FFV1P1N_1(W(1,13), W(1,49), GC_2, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,28,20,32,24/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,13), W(1,50), GC_2, TMP(1))
      call CombineAmp(8,
     & (/11,3,15,7,12,4,16,8/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,13), W(1,51), GC_2, TMP(1))
      call CombineAmp(8,
     & (/57,49,61,53,58,50,62,54/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,13), W(1,52), GC_2, TMP(1))
      call CombineAmp(6,
     & (/42,38,43,35,46,39/), 
     & (/53,56,57,58,59,60/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,14), W(1,49), GC_2, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,26,18,30,22/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,14), W(1,50), GC_2, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,10,2,14,6/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,14), W(1,51), GC_2, TMP(1))
      call CombineAmp(8,
     & (/55,47,59,51,56,48,60,52/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,14), W(1,52), GC_2, TMP(1))
      call CombineAmp(8,
     & (/40,33,44,36,41,34,45,37/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFS4_3(W(1,1),W(1,3),GC_84,MDL_MH,FK_MDL_WH,W(1,61))  !  count 48
      CALL FFS4_3(W(1,1),W(1,4),GC_84,MDL_MH,FK_MDL_WH,W(1,62))  !  count 48
      CALL FFS4_3(W(1,2),W(1,3),GC_84,MDL_MH,FK_MDL_WH,W(1,63))  !  count 48
      CALL FFS4_3(W(1,2),W(1,4),GC_84,MDL_MH,FK_MDL_WH,W(1,64))  !  count 42
      CALL FFS4P1N_1(W(1,13), W(1,61), GC_84, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,28,20,32,24/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,8))
      CALL FFS4P1N_1(W(1,13), W(1,62), GC_84, TMP(1))
      call CombineAmp(8,
     & (/11,3,15,7,12,4,16,8/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,8))
      CALL FFS4P1N_1(W(1,13), W(1,63), GC_84, TMP(1))
      call CombineAmp(8,
     & (/57,49,61,53,58,50,62,54/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,8))
      CALL FFS4P1N_1(W(1,13), W(1,64), GC_84, TMP(1))
      call CombineAmp(6,
     & (/42,38,43,35,46,39/), 
     & (/53,56,57,58,59,60/),
     & TMP, W, AMP(1,8))
      CALL FFS4P1N_1(W(1,14), W(1,61), GC_84, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,26,18,30,22/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,8))
      CALL FFS4P1N_1(W(1,14), W(1,62), GC_84, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,10,2,14,6/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,8))
      CALL FFS4P1N_1(W(1,14), W(1,63), GC_84, TMP(1))
      call CombineAmp(8,
     & (/55,47,59,51,56,48,60,52/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,8))
      CALL FFS4P1N_1(W(1,14), W(1,64), GC_84, TMP(1))
      call CombineAmp(8,
     & (/40,33,44,36,41,34,45,37/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,3),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,65))  !  count 48
      CALL FFV2_5_3(W(1,1),W(1,4),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,66))  !  count 48
      CALL FFV2_5_3(W(1,2),W(1,3),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,67))  !  count 48
      CALL FFV2_5_3(W(1,2),W(1,4),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,68))  !  count 42
      CALL FFV2_5P1N_1(W(1,13), W(1,65), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,28,20,32,24/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,9))
      CALL FFV2_5P1N_1(W(1,13), W(1,66), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/11,3,15,7,12,4,16,8/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,9))
      CALL FFV2_5P1N_1(W(1,13), W(1,67), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/57,49,61,53,58,50,62,54/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,9))
      CALL FFV2_5P1N_1(W(1,13), W(1,68), GC_51, GC_58, TMP(1))
      call CombineAmp(6,
     & (/42,38,43,35,46,39/), 
     & (/53,56,57,58,59,60/),
     & TMP, W, AMP(1,9))
      CALL FFV2_5P1N_1(W(1,14), W(1,65), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,26,18,30,22/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,9))
      CALL FFV2_5P1N_1(W(1,14), W(1,66), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,10,2,14,6/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,9))
      CALL FFV2_5P1N_1(W(1,14), W(1,67), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/55,47,59,51,56,48,60,52/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,9))
      CALL FFV2_5P1N_1(W(1,14), W(1,68), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/40,33,44,36,41,34,45,37/), 
     & (/53,54,55,56,57,58,59,60/),
     ...
     & TMP, W, AMP(1,11))  !  count 1
      CALL FFS4_1(W(1,13),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,69))  !  count 48
      CALL FFS4_1(W(1,13),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,70))  !  count 42
      CALL FFS4_1(W(1,13),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,71))  !  count 42
      CALL FFS4_1(W(1,13),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,72))  !  count 48
      CALL FFS4_1(W(1,14),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,73))  !  count 48
      CALL FFS4_1(W(1,14),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,74))  !  count 48
      CALL FFS4_1(W(1,14),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,75))  !  count 48
      CALL FFS4_1(W(1,14),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,76))  !  count 48
      CALL FFV1P1N_2(W(1,15), W(1,49), GC_2, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,25,17,29,21/), 
     ...
     & TMP, W, AMP(1,12))
      ...
      call CombineAmp(8,
     & (/58,50,62,54,56,48,60,52/), 
     & (/69,70,71,72,73,74,75,76/),
     & TMP, W, AMP(1,12))
      CALL FFV1P1N_2(W(1,16), W(1,52), GC_2, TMP(1))
      call CombineAmp(8,
     & (/43,35,46,39,41,34,45,37/), 
     & (/69,70,71,72,73,74,75,76/),
     ...
     & TMP, W, AMP(1,14))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,13),GC_2,ZERO,FK_ZERO,W(1,77))  !  count 32
      CALL FFV1P0_3(W(1,1),W(1,14),GC_2,ZERO,FK_ZERO,W(1,78))  !  count 32
      CALL FFV1P0_3(W(1,2),W(1,13),GC_2,ZERO,FK_ZERO,W(1,79))  !  count 28
      CALL FFV1P0_3(W(1,2),W(1,14),GC_2,ZERO,FK_ZERO,W(1,80))  !  count 32
      CALL FFV1P1N_1(W(1,3), W(1,77), GC_2, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,28,20,32,24/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,15))
      CALL FFV1P1N_1(W(1,3), W(1,78), GC_2, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,26,18,30,22/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,15))
      CALL FFV1P1N_1(W(1,3), W(1,79), GC_2, TMP(1))
      call CombineAmp(8,
     & (/57,49,61,53,58,50,62,54/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,15))
      CALL FFV1P1N_1(W(1,3), W(1,80), GC_2, TMP(1))
      call CombineAmp(8,
     & (/55,47,59,51,56,48,60,52/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,15))
      CALL FFV1P1N_1(W(1,4), W(1,77), GC_2, TMP(1))
      call CombineAmp(8,
     & (/11,3,15,7,12,4,16,8/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,15))
      CALL FFV1P1N_1(W(1,4), W(1,78), GC_2, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,10,2,14,6/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,15))
      CALL FFV1P1N_1(W(1,4), W(1,79), GC_2, TMP(1))
      call CombineAmp(6,
     & (/42,38,43,35,46,39/), 
     & (/53,56,57,58,59,60/),
     & TMP, W, AMP(1,15))
      CALL FFV1P1N_1(W(1,4), W(1,80), GC_2, TMP(1))
      call CombineAmp(8,
     & (/40,33,44,36,41,34,45,37/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,15))  !  count 1
      CALL FFS4_3(W(1,1),W(1,13),GC_84,MDL_MH,ZERO,W(1,81))  !  count 48
      CALL FFS4_3(W(1,1),W(1,14),GC_84,MDL_MH,ZERO,W(1,82))  !  count 48
      CALL FFS4_3(W(1,2),W(1,13),GC_84,MDL_MH,ZERO,W(1,83))  !  count 42
      CALL FFS4_3(W(1,2),W(1,14),GC_84,MDL_MH,ZERO,W(1,84))  !  count 48
      CALL FFS4P1N_1(W(1,3), W(1,81), GC_84, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,28,20,32,24/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,16))
      CALL FFS4P1N_1(W(1,3), W(1,82), GC_84, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,26,18,30,22/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,16))
      CALL FFS4P1N_1(W(1,3), W(1,83), GC_84, TMP(1))
      call CombineAmp(8,
     & (/57,49,61,53,58,50,62,54/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,16))
      CALL FFS4P1N_1(W(1,3), W(1,84), GC_84, TMP(1))
      call CombineAmp(8,
     & (/55,47,59,51,56,48,60,52/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,16))
      CALL FFS4P1N_1(W(1,4), W(1,81), GC_84, TMP(1))
      call CombineAmp(8,
     & (/11,3,15,7,12,4,16,8/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,16))
      CALL FFS4P1N_1(W(1,4), W(1,82), GC_84, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,10,2,14,6/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,16))
      CALL FFS4P1N_1(W(1,4), W(1,83), GC_84, TMP(1))
      call CombineAmp(6,
     & (/42,38,43,35,46,39/), 
     & (/53,56,57,58,59,60/),
     & TMP, W, AMP(1,16))
      CALL FFS4P1N_1(W(1,4), W(1,84), GC_84, TMP(1))
      call CombineAmp(8,
     & (/40,33,44,36,41,34,45,37/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,16))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,13),GC_51,GC_58,MDL_MZ,ZERO,W(1,85))  !  count 48
      CALL FFV2_5_3(W(1,1),W(1,14),GC_51,GC_58,MDL_MZ,ZERO,W(1,86))  !  count 48
      CALL FFV2_5_3(W(1,2),W(1,13),GC_51,GC_58,MDL_MZ,ZERO,W(1,87))  !  count 42
      CALL FFV2_5_3(W(1,2),W(1,14),GC_51,GC_58,MDL_MZ,ZERO,W(1,88))  !  count 48
      CALL FFV2_5P1N_1(W(1,3), W(1,85), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,28,20,32,24/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,17))
      CALL FFV2_5P1N_1(W(1,3), W(1,86), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,26,18,30,22/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,17))
      CALL FFV2_5P1N_1(W(1,3), W(1,87), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/57,49,61,53,58,50,62,54/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,17))
      CALL FFV2_5P1N_1(W(1,3), W(1,88), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/55,47,59,51,56,48,60,52/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,17))
      CALL FFV2_5P1N_1(W(1,4), W(1,85), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/11,3,15,7,12,4,16,8/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,17))
      CALL FFV2_5P1N_1(W(1,4), W(1,86), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,10,2,14,6/), 
     & (/53,54,55,56,57,58,59,60/),
     & TMP, W, AMP(1,17))
      CALL FFV2_5P1N_1(W(1,4), W(1,87), GC_51, GC_58, TMP(1))
      call CombineAmp(6,
     & (/42,38,43,35,46,39/), 
     & (/53,56,57,58,59,60/),
     & TMP, W, AMP(1,17))
      CALL FFV2_5P1N_1(W(1,4), W(1,88), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/40,33,44,36,41,34,45,37/), 
     & (/53,54,55,56,57,58,59,60/),
     ...
     & TMP, W, AMP(1,19))  !  count 1
      CALL FFS4_1(W(1,3),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,89))  !  count 48
      CALL FFS4_1(W(1,3),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,90))  !  count 48
      CALL FFS4_1(W(1,3),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,91))  !  count 48
      CALL FFS4_1(W(1,3),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,92))  !  count 48
      CALL FFS4_1(W(1,4),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,93))  !  count 48
      CALL FFS4_1(W(1,4),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,94))  !  count 42
      CALL FFS4_1(W(1,4),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,95))  !  count 42
      CALL FFS4_1(W(1,4),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,96))  !  count 48
      CALL FFV1P1N_2(W(1,15), W(1,77), GC_2, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,11,3,15,7/), 
     & (/89,90,91,92,93,94,95,96/),
     & TMP, W, AMP(1,20))
      CALL FFV1P1N_2(W(1,15), W(1,78), GC_2, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,9,1,13,5/), 
     & (/89,90,91,92,93,94,95,96/),
     & TMP, W, AMP(1,20))
