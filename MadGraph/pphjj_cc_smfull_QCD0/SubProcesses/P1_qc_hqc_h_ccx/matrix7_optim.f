...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,5),ZERO,+1,-1*IC(5),W(1,13))  !  count 2
      CALL IXXXXX(P(0,5),ZERO,-1,-1*IC(5),W(1,14))  !  count 2
      CALL IXXXXX(P(0,6),MDL_MC,+1,-1*IC(6),W(1,15))  !  count 38
      CALL IXXXXX(P(0,6),MDL_MC,-1,-1*IC(6),W(1,16))  !  count 38
      CALL FFV1P0_3(W(1,13),W(1,1),GC_2,ZERO,FK_ZERO,W(1,17))  !  count 32
      CALL FFV1P0_3(W(1,14),W(1,2),GC_2,ZERO,FK_ZERO,W(1,18))  !  count 32
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_3(W(1,13),W(1,1),GC_51,GC_58,MDL_MZ,ZERO,W(1,27))  !  count 48
      CALL FFV2_5_3(W(1,14),W(1,2),GC_51,GC_58,MDL_MZ,ZERO,W(1,28))  !  count 48
