...
C     
      ...
      PARAMETER (NWAVEFUNCS=48, NCOLOR=2) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),ZERO,+1,+1*IC(1),W(1,1))  !  count 20
      CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,2))  !  count 20
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,3))  !  count 40
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,4))  !  count 40
      ...
      CALL FFS4_3(W(1,7),W(1,5),GC_84,MDL_MH,FK_MDL_WH,W(1,9))  !  count 20
      CALL FFS4_3(W(1,7),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,10))  !  count 20
      CALL FFS4_3(W(1,8),W(1,5),GC_84,MDL_MH,FK_MDL_WH,W(1,11))  !  count 20
      CALL FFS4_3(W(1,8),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,12))  !  count 20
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,13))  !  count 20
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,14))  !  count 20
      CALL IXXXXX(P(0,6),MDL_MC,+1,-1*IC(6),W(1,15))  !  count 40
      CALL IXXXXX(P(0,6),MDL_MC,-1,-1*IC(6),W(1,16))  !  count 40
      CALL FFS4_2(W(1,15),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,17))  !  count 12
      CALL FFS4_2(W(1,15),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,18))  !  count 12
      CALL FFS4_2(W(1,15),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,19))  !  count 12
      CALL FFS4_2(W(1,15),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,20))  !  count 12
      CALL FFS4_2(W(1,16),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,21))  !  count 12
      CALL FFS4_2(W(1,16),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,22))  !  count 12
      CALL FFS4_2(W(1,16),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,23))  !  count 12
      CALL FFS4_2(W(1,16),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,24))  !  count 12
      CALL FFV2_3(W(1,1),W(1,3),GC_44,MDL_MW,FK_MDL_WW,W(1,25))  !  count 16
      CALL FFV2_3(W(1,1),W(1,4),GC_44,MDL_MW,FK_MDL_WW,W(1,26))  !  count 16
      CALL FFV2_3(W(1,2),W(1,3),GC_44,MDL_MW,FK_MDL_WW,W(1,27))  !  count 16
      CALL FFV2_3(W(1,2),W(1,4),GC_44,MDL_MW,FK_MDL_WW,W(1,28))  !  count 16
      CALL FFV2P1N_1(W(1,13), W(1,25), GC_103, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,14,10,16,12/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,13), W(1,26), GC_103, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,6,2,8,4/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,14), W(1,27), GC_103, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,30,26,32,28/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,14), W(1,28), GC_103, TMP(1))
      call CombineAmp(8,
     & (/21,17,23,19,22,18,24,20/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,13),GC_1,ZERO,FK_ZERO,W(1,29))  !  count 32
      CALL FFV1P0_3(W(1,2),W(1,14),GC_1,ZERO,FK_ZERO,W(1,30))  !  count 32
      CALL FFV1P1N_1(W(1,3), W(1,29), GC_2, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,14,10,16,12/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,3), W(1,30), GC_2, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,30,26,32,28/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,4), W(1,29), GC_2, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,6,2,8,4/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,4), W(1,30), GC_2, TMP(1))
      call CombineAmp(8,
     & (/21,17,23,19,22,18,24,20/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3_3(W(1,1),W(1,13),GC_50,GC_58,MDL_MZ,ZERO,W(1,31))  !  count 48
      CALL FFV2_3_3(W(1,2),W(1,14),GC_50,GC_58,MDL_MZ,ZERO,W(1,32))  !  count 48
      CALL FFV2_5P1N_1(W(1,3), W(1,31), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,14,10,16,12/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,3), W(1,32), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,30,26,32,28/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,4), W(1,31), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,6,2,8,4/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,4), W(1,32), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/21,17,23,19,22,18,24,20/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_3(W(1,15),W(1,3),GC_51,GC_58,MDL_MZ,ZERO,W(1,33))  !  count 8
      CALL FFV2_5_3(W(1,15),W(1,4),GC_51,GC_58,MDL_MZ,ZERO,W(1,34))  !  count 8
      CALL FFV2_5_3(W(1,16),W(1,3),GC_51,GC_58,MDL_MZ,ZERO,W(1,35))  !  count 8
      CALL FFV2_5_3(W(1,16),W(1,4),GC_51,GC_58,MDL_MZ,ZERO,W(1,36))  !  count 8
      CALL VVS1P1N_1(W(1,31), W(1,9), GC_81, TMP(1))
      call CombineAmp(4,
     & (/13,5,14,6/), 
     & (/33,34,35,36/),
     & TMP, W, AMP(1,4))
      CALL VVS1P1N_1(W(1,31), W(1,10), GC_81, TMP(1))
      call CombineAmp(4,
     & (/9,1,10,2/), 
     & (/33,34,35,36/),
     & TMP, W, AMP(1,4))
      CALL VVS1P1N_1(W(1,31), W(1,11), GC_81, TMP(1))
      call CombineAmp(4,
     & (/15,7,16,8/), 
     & (/33,34,35,36/),
     & TMP, W, AMP(1,4))
      CALL VVS1P1N_1(W(1,31), W(1,12), GC_81, TMP(1))
      call CombineAmp(4,
     & (/11,3,12,4/), 
     & (/33,34,35,36/),
     & TMP, W, AMP(1,4))
      CALL VVS1P1N_1(W(1,32), W(1,9), GC_81, TMP(1))
      call CombineAmp(4,
     & (/29,21,30,22/), 
     & (/33,34,35,36/),
     & TMP, W, AMP(1,4))
      CALL VVS1P1N_1(W(1,32), W(1,10), GC_81, TMP(1))
      call CombineAmp(4,
     & (/25,17,26,18/), 
     & (/33,34,35,36/),
     & TMP, W, AMP(1,4))
      CALL VVS1P1N_1(W(1,32), W(1,11), GC_81, TMP(1))
      call CombineAmp(4,
     & (/31,23,32,24/), 
     & (/33,34,35,36/),
     & TMP, W, AMP(1,4))
      CALL VVS1P1N_1(W(1,32), W(1,12), GC_81, TMP(1))
      call CombineAmp(4,
     & (/27,19,28,20/), 
     & (/33,34,35,36/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3(W(1,15),W(1,13),GC_103,MDL_MW,FK_MDL_WW,W(1,37))  !  count 16
      CALL FFV2_3(W(1,15),W(1,14),GC_103,MDL_MW,FK_MDL_WW,W(1,38))  !  count 16
      CALL FFV2_3(W(1,16),W(1,13),GC_103,MDL_MW,FK_MDL_WW,W(1,39))  !  count 16
      CALL FFV2_3(W(1,16),W(1,14),GC_103,MDL_MW,FK_MDL_WW,W(1,40))  !  count 16
      CALL VVS1P1N_1(W(1,25), W(1,9), GC_72, TMP(1))
      call CombineAmp(2,
     & (/13,14/), 
     & (/37,39/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,25), W(1,10), GC_72, TMP(1))
      call CombineAmp(2,
     & (/9,10/), 
     & (/37,39/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,25), W(1,11), GC_72, TMP(1))
      call CombineAmp(2,
     & (/15,16/), 
     & (/37,39/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,25), W(1,12), GC_72, TMP(1))
      call CombineAmp(2,
     & (/11,12/), 
     & (/37,39/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,26), W(1,9), GC_72, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/37,39/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,26), W(1,10), GC_72, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/37,39/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,26), W(1,11), GC_72, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/37,39/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,26), W(1,12), GC_72, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/37,39/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,27), W(1,9), GC_72, TMP(1))
      call CombineAmp(2,
     & (/29,30/), 
     & (/38,40/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,27), W(1,10), GC_72, TMP(1))
      call CombineAmp(2,
     & (/25,26/), 
     & (/38,40/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,27), W(1,11), GC_72, TMP(1))
      call CombineAmp(2,
     & (/31,32/), 
     & (/38,40/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,27), W(1,12), GC_72, TMP(1))
      call CombineAmp(2,
     & (/27,28/), 
     & (/38,40/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,28), W(1,9), GC_72, TMP(1))
      call CombineAmp(2,
     & (/21,22/), 
     & (/38,40/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,28), W(1,10), GC_72, TMP(1))
      call CombineAmp(2,
     & (/17,18/), 
     & (/38,40/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,28), W(1,11), GC_72, TMP(1))
      call CombineAmp(2,
     & (/23,24/), 
     & (/38,40/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,28), W(1,12), GC_72, TMP(1))
      call CombineAmp(2,
     & (/19,20/), 
     & (/38,40/),
     & TMP, W, AMP(1,5))  !  count 1
      CALL FFS4_1(W(1,3),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,41))  !  count 12
      CALL FFS4_1(W(1,3),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,42))  !  count 12
      CALL FFS4_1(W(1,3),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,43))  !  count 12
      CALL FFS4_1(W(1,3),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,44))  !  count 12
      CALL FFS4_1(W(1,4),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,45))  !  count 12
      CALL FFS4_1(W(1,4),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,46))  !  count 12
      CALL FFS4_1(W(1,4),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,47))  !  count 12
      CALL FFS4_1(W(1,4),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,48))  !  count 12
      CALL FFV2P1N_2(W(1,1), W(1,37), GC_44, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,5,1,7,3/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,1), W(1,39), GC_44, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,6,2,8,4/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,2), W(1,38), GC_44, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,21,17,23,19/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,2), W(1,40), GC_44, TMP(1))
      call CombineAmp(8,
     & (/30,26,32,28,22,18,24,20/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1P1N_2(W(1,15), W(1,29), GC_2, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,5,1,7,3/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_2(W(1,15), W(1,30), GC_2, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,21,17,23,19/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_2(W(1,16), W(1,29), GC_2, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,6,2,8,4/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_2(W(1,16), W(1,30), GC_2, TMP(1))
      call CombineAmp(8,
     & (/30,26,32,28,22,18,24,20/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV2_5P1N_2(W(1,15), W(1,31), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,5,1,7,3/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,8))
      CALL FFV2_5P1N_2(W(1,15), W(1,32), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,21,17,23,19/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,8))
      CALL FFV2_5P1N_2(W(1,16), W(1,31), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,6,2,8,4/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,8))
      CALL FFV2_5P1N_2(W(1,16), W(1,32), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/30,26,32,28,22,18,24,20/), 
     & (/41,42,43,44,45,46,47,48/),
