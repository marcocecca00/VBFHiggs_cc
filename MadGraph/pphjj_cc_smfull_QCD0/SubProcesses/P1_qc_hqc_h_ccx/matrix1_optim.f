...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),ZERO,+1,+1*IC(1),W(1,1))  !  count 2
      CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,2))  !  count 2
      CALL IXXXXX(P(0,2),MDL_MC,+1,+1*IC(2),W(1,3))  !  count 38
      CALL IXXXXX(P(0,2),MDL_MC,-1,+1*IC(2),W(1,4))  !  count 38
      ...
      CALL FFS4_3(W(1,7),W(1,5),GC_84,MDL_MH,FK_MDL_WH,W(1,9))  !  count 12
      CALL FFS4_3(W(1,7),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,10))  !  count 12
      CALL FFS4_3(W(1,8),W(1,5),GC_84,MDL_MH,FK_MDL_WH,W(1,11))  !  count 12
      CALL FFS4_3(W(1,8),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,12))  !  count 12
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,13))  !  count 2
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,14))  !  count 2
      CALL OXXXXX(P(0,6),MDL_MC,+1,+1*IC(6),W(1,15))  !  count 38
      CALL OXXXXX(P(0,6),MDL_MC,-1,+1*IC(6),W(1,16))  !  count 38
      CALL FFV1P0_3(W(1,1),W(1,13),GC_2,ZERO,FK_ZERO,W(1,17))  !  count 32
      CALL FFV1P0_3(W(1,2),W(1,14),GC_2,ZERO,FK_ZERO,W(1,18))  !  count 32
      CALL FFS4_2(W(1,3),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,19))  !  count 8
      CALL FFS4_2(W(1,3),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,20))  !  count 8
      CALL FFS4_2(W(1,3),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,21))  !  count 8
      CALL FFS4_2(W(1,3),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,22))  !  count 8
      CALL FFS4_2(W(1,4),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,23))  !  count 8
      CALL FFS4_2(W(1,4),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,24))  !  count 8
      CALL FFS4_2(W(1,4),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,25))  !  count 8
      CALL FFS4_2(W(1,4),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,26))  !  count 8
      CALL FFV1P1N_1(W(1,15), W(1,17), GC_2, TMP(1))
      call CombineAmp(8,
     & (/6,2,8,4,14,10,16,12/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,15), W(1,18), GC_2, TMP(1))
      call CombineAmp(8,
     & (/22,18,24,20,30,26,32,28/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,16), W(1,17), GC_2, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,13,9,15,11/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,16), W(1,18), GC_2, TMP(1))
      call CombineAmp(8,
     & (/21,17,23,19,29,25,31,27/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,13),GC_51,GC_58,MDL_MZ,ZERO,W(1,27))  !  count 48
      CALL FFV2_5_3(W(1,2),W(1,14),GC_51,GC_58,MDL_MZ,ZERO,W(1,28))  !  count 48
      CALL FFV2_5P1N_1(W(1,15), W(1,27), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/6,2,8,4,14,10,16,12/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,15), W(1,28), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/22,18,24,20,30,26,32,28/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,16), W(1,27), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,13,9,15,11/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,16), W(1,28), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/21,17,23,19,29,25,31,27/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_3(W(1,3),W(1,15),GC_51,GC_58,MDL_MZ,ZERO,W(1,29))  !  count 8
      CALL FFV2_5_3(W(1,3),W(1,16),GC_51,GC_58,MDL_MZ,ZERO,W(1,30))  !  count 8
      CALL FFV2_5_3(W(1,4),W(1,15),GC_51,GC_58,MDL_MZ,ZERO,W(1,31))  !  count 8
      CALL FFV2_5_3(W(1,4),W(1,16),GC_51,GC_58,MDL_MZ,ZERO,W(1,32))  !  count 8
      CALL VVS1P1N_2(W(1,27), W(1,9), GC_81, TMP(1))
      call CombineAmp(4,
     & (/6,5,14,13/), 
     & (/29,30,31,32/),
     & TMP, W, AMP(1,3))
      CALL VVS1P1N_2(W(1,27), W(1,10), GC_81, TMP(1))
      call CombineAmp(4,
     & (/2,1,10,9/), 
     & (/29,30,31,32/),
     & TMP, W, AMP(1,3))
      CALL VVS1P1N_2(W(1,27), W(1,11), GC_81, TMP(1))
      call CombineAmp(4,
     & (/8,7,16,15/), 
     & (/29,30,31,32/),
     & TMP, W, AMP(1,3))
      CALL VVS1P1N_2(W(1,27), W(1,12), GC_81, TMP(1))
      call CombineAmp(4,
     & (/4,3,12,11/), 
     & (/29,30,31,32/),
     & TMP, W, AMP(1,3))
      CALL VVS1P1N_2(W(1,28), W(1,9), GC_81, TMP(1))
      call CombineAmp(4,
     & (/22,21,30,29/), 
     & (/29,30,31,32/),
     & TMP, W, AMP(1,3))
      CALL VVS1P1N_2(W(1,28), W(1,10), GC_81, TMP(1))
      call CombineAmp(4,
     & (/18,17,26,25/), 
     & (/29,30,31,32/),
     & TMP, W, AMP(1,3))
      CALL VVS1P1N_2(W(1,28), W(1,11), GC_81, TMP(1))
      call CombineAmp(4,
     & (/24,23,32,31/), 
     & (/29,30,31,32/),
     & TMP, W, AMP(1,3))
      CALL VVS1P1N_2(W(1,28), W(1,12), GC_81, TMP(1))
      call CombineAmp(4,
     & (/20,19,28,27/), 
     & (/29,30,31,32/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFS4_1(W(1,15),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,33))  !  count 8
      CALL FFS4_1(W(1,15),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,34))  !  count 8
      CALL FFS4_1(W(1,15),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,35))  !  count 8
      CALL FFS4_1(W(1,15),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,36))  !  count 8
      CALL FFS4_1(W(1,16),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,37))  !  count 8
      CALL FFS4_1(W(1,16),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,38))  !  count 8
      CALL FFS4_1(W(1,16),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,39))  !  count 8
      CALL FFS4_1(W(1,16),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,40))  !  count 8
      CALL FFV1P1N_2(W(1,3), W(1,17), GC_2, TMP(1))
      call CombineAmp(8,
     & (/6,2,8,4,5,1,7,3/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_2(W(1,3), W(1,18), GC_2, TMP(1))
      call CombineAmp(8,
     & (/22,18,24,20,21,17,23,19/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_2(W(1,4), W(1,17), GC_2, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,13,9,15,11/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_2(W(1,4), W(1,18), GC_2, TMP(1))
      call CombineAmp(8,
     & (/30,26,32,28,29,25,31,27/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_5P1N_2(W(1,3), W(1,27), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/6,2,8,4,5,1,7,3/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,5))
      CALL FFV2_5P1N_2(W(1,3), W(1,28), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/22,18,24,20,21,17,23,19/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,5))
      CALL FFV2_5P1N_2(W(1,4), W(1,27), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,13,9,15,11/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,5))
      CALL FFV2_5P1N_2(W(1,4), W(1,28), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/30,26,32,28,29,25,31,27/), 
     & (/33,34,35,36,37,38,39,40/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
        JAMP(1,1) = AMP( K,1)+AMP( K,2)+AMP( K,3)+AMP( K,4)+AMP( K,5)
        ...
        IF(SDE_STRAT.EQ.1)THEN
          AMP2(1)=AMP2(1)+(AMP( K,1)+AMP( K,2))*DCONJG(AMP( K,1)+AMP( K,
     $    2))
