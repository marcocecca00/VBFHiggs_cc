...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_44,MDL_MW,FK_MDL_WW,W(1,23))  !  count 16
      CALL FFV2_3(W(1,1),W(1,3),GC_44,MDL_MW,FK_MDL_WW,W(1,24))  !  count 16
      CALL FFV2P1N_1(W(1,12), W(1,23), GC_104, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,14,10,16,12/), 
     & (/15,16,17,18,19,20,21,22/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,12), W(1,24), GC_104, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,6,2,8,4/), 
     & (/15,16,17,18,19,20,21,22/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,13),W(1,12),GC_104,MDL_MW,FK_MDL_WW,W(1,25))  !  count 16
      CALL FFV2_3(W(1,14),W(1,12),GC_104,MDL_MW,FK_MDL_WW,W(1,26))  !  count 16
