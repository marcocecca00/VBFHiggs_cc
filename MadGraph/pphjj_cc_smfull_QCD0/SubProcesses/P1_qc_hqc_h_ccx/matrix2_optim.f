...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,3))  !  count 38
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,4))  !  count 38
      ...
      CALL IXXXXX(P(0,6),MDL_MC,+1,-1*IC(6),W(1,15))  !  count 38
      CALL IXXXXX(P(0,6),MDL_MC,-1,-1*IC(6),W(1,16))  !  count 38
      CALL FFV1P0_3(W(1,1),W(1,13),GC_2,ZERO,FK_ZERO,W(1,17))  !  count 32
      CALL FFV1P0_3(W(1,2),W(1,14),GC_2,ZERO,FK_ZERO,W(1,18))  !  count 32
      CALL FFS4_2(W(1,15),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,19))  !  count 8
      CALL FFS4_2(W(1,15),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,20))  !  count 8
      CALL FFS4_2(W(1,15),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,21))  !  count 8
      CALL FFS4_2(W(1,15),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,22))  !  count 8
      CALL FFS4_2(W(1,16),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,23))  !  count 8
      CALL FFS4_2(W(1,16),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,24))  !  count 8
      CALL FFS4_2(W(1,16),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,25))  !  count 8
      CALL FFS4_2(W(1,16),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,26))  !  count 8
      CALL FFV1P1N_1(W(1,3), W(1,17), GC_2, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,14,10,16,12/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,3), W(1,18), GC_2, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,30,26,32,28/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,4), W(1,17), GC_2, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,6,2,8,4/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,4), W(1,18), GC_2, TMP(1))
      call CombineAmp(8,
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV2_5P1N_1(W(1,3), W(1,27), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,14,10,16,12/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,3), W(1,28), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,30,26,32,28/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,4), W(1,27), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,6,2,8,4/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,4), W(1,28), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/21,17,23,19,22,18,24,20/), 
     & (/19,20,21,22,23,24,25,26/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_3(W(1,15),W(1,3),GC_51,GC_58,MDL_MZ,ZERO,W(1,29))  !  count 8
      CALL FFV2_5_3(W(1,15),W(1,4),GC_51,GC_58,MDL_MZ,ZERO,W(1,30))  !  count 8
      CALL FFV2_5_3(W(1,16),W(1,3),GC_51,GC_58,MDL_MZ,ZERO,W(1,31))  !  count 8
      CALL FFV2_5_3(W(1,16),W(1,4),GC_51,GC_58,MDL_MZ,ZERO,W(1,32))  !  count 8
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFS4_1(W(1,3),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,33))  !  count 8
      CALL FFS4_1(W(1,3),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,34))  !  count 8
      CALL FFS4_1(W(1,3),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,35))  !  count 8
      CALL FFS4_1(W(1,3),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,36))  !  count 8
      CALL FFS4_1(W(1,4),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,37))  !  count 8
      CALL FFS4_1(W(1,4),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,38))  !  count 8
      CALL FFS4_1(W(1,4),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,39))  !  count 8
      CALL FFS4_1(W(1,4),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,40))  !  count 8
      CALL FFV1P1N_2(W(1,15), W(1,17), GC_2, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,5,1,7,3/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_2(W(1,15), W(1,18), GC_2, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,21,17,23,19/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_2(W(1,16), W(1,17), GC_2, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,6,2,8,4/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_2(W(1,16), W(1,18), GC_2, TMP(1))
      call CombineAmp(8,
     & (/30,26,32,28,22,18,24,20/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_5P1N_2(W(1,15), W(1,27), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,5,1,7,3/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,5))
      CALL FFV2_5P1N_2(W(1,15), W(1,28), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,21,17,23,19/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,5))
      CALL FFV2_5P1N_2(W(1,16), W(1,27), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,6,2,8,4/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,5))
      CALL FFV2_5P1N_2(W(1,16), W(1,28), GC_51, GC_58, TMP(1))
      call CombineAmp(8,
     & (/30,26,32,28,22,18,24,20/), 
     & (/33,34,35,36,37,38,39,40/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
     ...
     $  00D+00)*AMP( K,4)+(-1.000000000000000D+00)*AMP( K,5)
