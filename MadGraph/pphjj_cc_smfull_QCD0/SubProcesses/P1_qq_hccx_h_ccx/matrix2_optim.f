...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_3(W(1,1),W(1,13),GC_44,MDL_MW,ZERO,W(1,25))  !  count 16
      CALL FFV2_3(W(1,1),W(1,14),GC_44,MDL_MW,ZERO,W(1,26))  !  count 16
      CALL FFV2_3(W(1,2),W(1,13),GC_44,MDL_MW,ZERO,W(1,27))  !  count 16
      CALL FFV2_3(W(1,2),W(1,14),GC_44,MDL_MW,ZERO,W(1,28))  !  count 16
      CALL FFV2P1N_1(W(1,3), W(1,27), GC_103, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,28,20,32,24/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,3), W(1,28), GC_103, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,26,18,30,22/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,4), W(1,25), GC_103, TMP(1))
      call CombineAmp(8,
     & (/11,3,15,7,12,4,16,8/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,4), W(1,26), GC_103, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,10,2,14,6/), 
     & (/17,18,19,20,21,22,23,24/),
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3(W(1,15),W(1,3),GC_103,MDL_MW,ZERO,W(1,37))  !  count 16
      CALL FFV2_3(W(1,15),W(1,4),GC_103,MDL_MW,ZERO,W(1,38))  !  count 16
      CALL FFV2_3(W(1,16),W(1,3),GC_103,MDL_MW,ZERO,W(1,39))  !  count 16
      CALL FFV2_3(W(1,16),W(1,4),GC_103,MDL_MW,ZERO,W(1,40))  !  count 16
     ...
     & TMP, W, AMP(1,5))  !  count 1
      ...
      CALL FFV2P1N_2(W(1,1), W(1,38), GC_44, TMP(1))
      call CombineAmp(8,
     & (/11,3,15,7,9,1,13,5/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,1), W(1,40), GC_44, TMP(1))
      call CombineAmp(8,
     & (/12,4,16,8,10,2,14,6/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,2), W(1,37), GC_44, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,25,17,29,21/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,2), W(1,39), GC_44, TMP(1))
      call CombineAmp(8,
