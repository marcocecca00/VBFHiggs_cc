...
C     
      ...
      PARAMETER (NWAVEFUNCS=34, NCOLOR=1) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,1))  !  count 16
      CALL OXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,2))  !  count 16
      CALL OXXXXX(P(0,3),MDL_MC,+1,+1*IC(3),W(1,3))  !  count 2
      CALL OXXXXX(P(0,3),MDL_MC,-1,+1*IC(3),W(1,4))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MC,+1,-1*IC(4),W(1,5))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MC,-1,-1*IC(4),W(1,6))  !  count 2
      CALL FFS4_3(W(1,5),W(1,3),GC_84,MDL_MH,FK_MDL_WH,W(1,7))  !  count 8
      CALL FFS4_3(W(1,5),W(1,4),GC_84,MDL_MH,FK_MDL_WH,W(1,8))  !  count 7
      CALL FFS4_3(W(1,6),W(1,3),GC_84,MDL_MH,FK_MDL_WH,W(1,9))  !  count 7
      CALL FFS4_3(W(1,6),W(1,4),GC_84,MDL_MH,FK_MDL_WH,W(1,10))  !  count 8
      CALL OXXXXX(P(0,5),MDL_MC,+1,+1*IC(5),W(1,11))  !  count 5
      CALL OXXXXX(P(0,5),MDL_MC,-1,+1*IC(5),W(1,12))  !  count 5
      CALL IXXXXX(P(0,6),MDL_MC,+1,-1*IC(6),W(1,13))  !  count 5
      CALL IXXXXX(P(0,6),MDL_MC,-1,-1*IC(6),W(1,14))  !  count 5
      CALL FFS4_2(W(1,13),W(1,7),GC_84,MDL_MC,FK_ZERO,W(1,15))  !  count 2
      CALL FFS4_2(W(1,13),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,16))  !  count 2
      CALL FFS4_2(W(1,13),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,17))  !  count 2
      CALL FFS4_2(W(1,13),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,18))  !  count 2
      CALL FFS4_2(W(1,14),W(1,7),GC_84,MDL_MC,FK_ZERO,W(1,19))  !  count 2
      CALL FFS4_2(W(1,14),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,20))  !  count 1
      CALL FFS4_2(W(1,14),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,21))  !  count 1
      CALL FFS4_2(W(1,14),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,22))  !  count 2
      CALL FFV2_3(W(1,1),W(1,11),GC_44,MDL_MW,ZERO,W(1,23))  !  count 12
      CALL FFV2_3(W(1,1),W(1,12),GC_44,MDL_MW,ZERO,W(1,24))  !  count 16
      CALL FFV2P1N_1(W(1,2), W(1,23), GC_104, TMP(1))
      call CombineAmp(6,
     & (/10,3,14,6,11,7/), 
     & (/15,16,17,18,19,22/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,2), W(1,24), GC_104, TMP(1))
      call CombineAmp(8,
     & (/8,1,12,4,9,2,13,5/), 
     & (/15,16,17,18,19,20,21,22/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,13),W(1,2),GC_104,MDL_MW,ZERO,W(1,25))  !  count 16
      CALL FFV2_3(W(1,14),W(1,2),GC_104,MDL_MW,ZERO,W(1,26))  !  count 12
      CALL VVS1P1N_3(W(1,25), W(1,23), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/10,3,14,6/), 
     & (/7,8,9,10/), 
     & TMP, W, AMP(1,2))
      CALL VVS1P1N_3(W(1,25), W(1,24), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/8,1,12,4/), 
     & (/7,8,9,10/), 
     & TMP, W, AMP(1,2))
      CALL VVS1P1N_3(W(1,26), W(1,23), GC_72, TMP(1))
      call CombineAmpS(2, 
     &(/11,7/), 
     & (/7,10/), 
     & TMP, W, AMP(1,2))
      CALL VVS1P1N_3(W(1,26), W(1,24), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/9,2,13,5/), 
     & (/7,8,9,10/), 
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS4_1(W(1,11),W(1,7),GC_84,MDL_MC,FK_ZERO,W(1,27))  !  count 2
      CALL FFS4_1(W(1,11),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,28))  !  count 1
      CALL FFS4_1(W(1,11),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,29))  !  count 1
      CALL FFS4_1(W(1,11),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,30))  !  count 2
      CALL FFS4_1(W(1,12),W(1,7),GC_84,MDL_MC,FK_ZERO,W(1,31))  !  count 2
      CALL FFS4_1(W(1,12),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,32))  !  count 2
      CALL FFS4_1(W(1,12),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,33))  !  count 2
      CALL FFS4_1(W(1,12),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,34))  !  count 2
      CALL FFV2P1N_2(W(1,1), W(1,25), GC_44, TMP(1))
      call CombineAmp(8,
     & (/10,3,14,6,8,1,12,4/), 
     & (/27,28,29,30,31,32,33,34/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_2(W(1,1), W(1,26), GC_44, TMP(1))
      call CombineAmp(6,
     & (/11,7,9,2,13,5/), 
     & (/27,30,31,32,33,34/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
     ...
     $  00D +00)*AMP( K,2)+(-1.000000000000000D+00)*AMP( K,3)
