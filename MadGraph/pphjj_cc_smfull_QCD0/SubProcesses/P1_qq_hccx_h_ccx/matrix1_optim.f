...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO,FK_ZERO,W(1,17))  !  count 32
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO,FK_ZERO,W(1,18))  !  count 32
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,27))  !  count 48
      CALL FFV2_5_3(W(1,2),W(1,3),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,28))  !  count 48
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_3(W(1,15),W(1,13),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,29)
     $)  !  count 8
      CALL FFV2_5_3(W(1,15),W(1,14),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,30)
     $)  !  count 8
      CALL FFV2_5_3(W(1,16),W(1,13),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,31)
     $)  !  count 8
      CALL FFV2_5_3(W(1,16),W(1,14),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,32)
     $)  !  count 8
