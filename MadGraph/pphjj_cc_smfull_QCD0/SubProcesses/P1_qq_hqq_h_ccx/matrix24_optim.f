...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFS4_3(W(1,5),W(1,3),GC_84,MDL_MH,FK_MDL_WH,W(1,7))  !  count 1
      CALL FFS4_3(W(1,5),W(1,4),GC_84,MDL_MH,FK_MDL_WH,W(1,8))  !  count 1
      CALL FFS4_3(W(1,6),W(1,3),GC_84,MDL_MH,FK_MDL_WH,W(1,9))  !  count 1
      CALL FFS4_3(W(1,6),W(1,4),GC_84,MDL_MH,FK_MDL_WH,W(1,10))  !  count 1
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,11))  !  count 1
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,12))  !  count 1
      CALL FFV2_3(W(1,12),W(1,11),GC_100,MDL_MW,FK_MDL_WW,W(1,13))  !  count 4
      CALL FFV2_3(W(1,1),W(1,2),GC_42,MDL_MW,FK_MDL_WW,W(1,14))  !  count 4
      CALL VVS1P1N_3(W(1,13), W(1,14), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/7,8,9,10/), 
