...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL IXXXXX(P(0,2),ZERO,-1,+1*IC(2),W(1,2))  !  count 1
      ...
      CALL FFV2_3(W(1,1),W(1,12),GC_101,MDL_MW,ZERO,W(1,13))  !  count 4
      CALL FFV2_3(W(1,2),W(1,11),GC_41,MDL_MW,ZERO,W(1,14))  !  count 4
