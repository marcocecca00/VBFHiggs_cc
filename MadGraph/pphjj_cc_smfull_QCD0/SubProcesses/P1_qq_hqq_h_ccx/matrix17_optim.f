...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_5_3(W(1,15),W(1,3),GC_51,GC_58,MDL_MZ,ZERO,W(1,17))  !  count 8
      CALL FFV2_5_3(W(1,16),W(1,4),GC_51,GC_58,MDL_MZ,ZERO,W(1,18))  !  count 8
      CALL FFV2_3_3(W(1,1),W(1,13),GC_50,GC_58,MDL_MZ,ZERO,W(1,19))  !  count 8
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,15),W(1,13),GC_100,MDL_MW,FK_MDL_WW,W(1,21))  !  count 4
      CALL FFV2_3(W(1,15),W(1,14),GC_100,MDL_MW,FK_MDL_WW,W(1,22))  !  count 4
      CALL FFV2_3(W(1,16),W(1,13),GC_100,MDL_MW,FK_MDL_WW,W(1,23))  !  count 4
      CALL FFV2_3(W(1,16),W(1,14),GC_100,MDL_MW,FK_MDL_WW,W(1,24))  !  count 4
      CALL FFV2_3(W(1,1),W(1,3),GC_41,MDL_MW,FK_MDL_WW,W(1,25))  !  count 4
      CALL FFV2_3(W(1,1),W(1,4),GC_41,MDL_MW,FK_MDL_WW,W(1,26))  !  count 4
      CALL FFV2_3(W(1,2),W(1,3),GC_41,MDL_MW,FK_MDL_WW,W(1,27))  !  count 4
      CALL FFV2_3(W(1,2),W(1,4),GC_41,MDL_MW,FK_MDL_WW,W(1,28))  !  count 4
      CALL VVS1_0(W(1,21),W(1,25),W(1,9),GC_72,AMP(7,2))
      CALL VVS1_0(W(1,21),W(1,25),W(1,10),GC_72,AMP(5,2))
      CALL VVS1_0(W(1,21),W(1,25),W(1,11),GC_72,AMP(8,2))
      CALL VVS1_0(W(1,21),W(1,25),W(1,12),GC_72,AMP(6,2))
      CALL VVS1_0(W(1,22),W(1,27),W(1,9),GC_72,AMP(15,2))
      CALL VVS1_0(W(1,22),W(1,27),W(1,10),GC_72,AMP(13,2))
      CALL VVS1_0(W(1,22),W(1,27),W(1,11),GC_72,AMP(16,2))
      CALL VVS1_0(W(1,22),W(1,27),W(1,12),GC_72,AMP(14,2))
      CALL VVS1_0(W(1,23),W(1,26),W(1,9),GC_72,AMP(3,2))
      CALL VVS1_0(W(1,23),W(1,26),W(1,10),GC_72,AMP(1,2))
      CALL VVS1_0(W(1,23),W(1,26),W(1,11),GC_72,AMP(4,2))
      CALL VVS1_0(W(1,23),W(1,26),W(1,12),GC_72,AMP(2,2))
      CALL VVS1_0(W(1,24),W(1,28),W(1,9),GC_72,AMP(11,2))
      CALL VVS1_0(W(1,24),W(1,28),W(1,10),GC_72,AMP(9,2))
      CALL VVS1_0(W(1,24),W(1,28),W(1,11),GC_72,AMP(12,2))
      CALL VVS1_0(W(1,24),W(1,28),W(1,12),GC_72,AMP(10,2))  !  count 1
...
C       JAMPs contributing to orders ALL_ORDERS=1
        JAMP(1,1) = AMP( K,2)
        JAMP(2,1) = (-1.000000000000000D+00)*AMP( K,1)
