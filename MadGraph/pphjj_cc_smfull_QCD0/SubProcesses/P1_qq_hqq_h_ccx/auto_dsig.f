...
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u d > h u s QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u s > h u d QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u s > h u s QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u u~ > h u u~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u u~ > h d d~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u u~ > h d s~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u u~ > h s d~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u u~ > h s s~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u d~ > h u d~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u d~ > h u s~ QCD=0 @1
...
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: d s > h d s QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: d u~ > h d u~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: d u~ > h s u~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: d d~ > h u u~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: d d~ > h d d~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: s s~ > h s s~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: d d~ > h s s~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: s s~ > h d d~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: d s~ > h u u~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: d s~ > h d s~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: s d~ > h s d~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: s u~ > h d u~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: s u~ > h s u~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: s d~ > h u u~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: s s~ > h u u~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u~ u~ > h u~ u~ QCD=0 @1
C     *   Decay: h > c c~ WEIGHTED<=2
C     Process: u~ d~ > h u~ d~ QCD=0 @1
...
C       Output weights and number of events
        ...
        IF (SUMPROB.NE.0D0)THEN
          DO J=1,SYMCONF(0)
            WRITE(*,'(68E12.4)')((SUMWGT(K,I,J)/SUMPROB,K=1,2),I=1
     $       ,MAXSPROC)
          ENDDO
        ENDIF
        SUMPROB=0D0
        ...
        IF (SUMPROB.NE.0D0)THEN
          DO J=1,SYMCONF(0)
            WRITE(*,'(68E12.4)')((NUMEVTS(K,I,J)/SUMPROB,K=1,2),I=1
     $       ,MAXSPROC)
          ENDDO
        ENDIF
        WRITE(*,*)'Events:'
        DO J=1,SYMCONF(0)
          WRITE(*,'(68I12)')((NUMEVTS(K,I,J),K=1,2),I=1,MAXSPROC)
        ENDDO
...
C     
     ...
     $ ,DSIG27,DSIG28,DSIG29,DSIG30,DSIG31,DSIG32,DSIG33,DSIG34
      LOGICAL PASSCUTS
C     
C     LOCAL VARIABLES 
C     
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        ENDIF
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u > c c~ u u
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u d > c c~ u d
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! u d > c c~ u s
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! u s > c c~ u d
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u s > c c~ u s
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! u u~ > c c~ u u~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! u u~ > c c~ d d~
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! u u~ > c c~ d s~
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! u u~ > c c~ s d~
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! u u~ > c c~ s s~
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! u d~ > c c~ u d~
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! u d~ > c c~ u s~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! u s~ > c c~ u d~
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! u s~ > c c~ u s~
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! d d > c c~ d d
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! d s > c c~ d s
        IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! d u~ > c c~ d u~
        IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! d u~ > c c~ s u~
        IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! d d~ > c c~ u u~
        IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! d d~ > c c~ d d~
        IF(IPROC.EQ.21) DSIGPROC=DSIG21(P1,WGT,IMODE)  ! d d~ > c c~ s s~
        IF(IPROC.EQ.22) DSIGPROC=DSIG22(P1,WGT,IMODE)  ! d s~ > c c~ u u~
        IF(IPROC.EQ.23) DSIGPROC=DSIG23(P1,WGT,IMODE)  ! d s~ > c c~ d s~
        IF(IPROC.EQ.24) DSIGPROC=DSIG24(P1,WGT,IMODE)  ! s u~ > c c~ d u~
        IF(IPROC.EQ.25) DSIGPROC=DSIG25(P1,WGT,IMODE)  ! s u~ > c c~ s u~
        IF(IPROC.EQ.26) DSIGPROC=DSIG26(P1,WGT,IMODE)  ! s d~ > c c~ u u~
        IF(IPROC.EQ.27) DSIGPROC=DSIG27(P1,WGT,IMODE)  ! s s~ > c c~ u u~
        IF(IPROC.EQ.28) DSIGPROC=DSIG28(P1,WGT,IMODE)  ! u~ u~ > c c~ u~ u~
        IF(IPROC.EQ.29) DSIGPROC=DSIG29(P1,WGT,IMODE)  ! u~ d~ > c c~ u~ d~
        IF(IPROC.EQ.30) DSIGPROC=DSIG30(P1,WGT,IMODE)  ! u~ d~ > c c~ u~ s~
        IF(IPROC.EQ.31) DSIGPROC=DSIG31(P1,WGT,IMODE)  ! u~ s~ > c c~ u~ d~
        IF(IPROC.EQ.32) DSIGPROC=DSIG32(P1,WGT,IMODE)  ! u~ s~ > c c~ u~ s~
        IF(IPROC.EQ.33) DSIGPROC=DSIG33(P1,WGT,IMODE)  ! d~ d~ > c c~ d~ d~
        IF(IPROC.EQ.34) DSIGPROC=DSIG34(P1,WGT,IMODE)  ! d~ s~ > c c~ d~ s~
      ENDIF
...
C     
      ...
      CALL PRINT_ZERO_AMP21()
      CALL PRINT_ZERO_AMP22()
      CALL PRINT_ZERO_AMP23()
      CALL PRINT_ZERO_AMP24()
      CALL PRINT_ZERO_AMP25()
      CALL PRINT_ZERO_AMP26()
      CALL PRINT_ZERO_AMP27()
      CALL PRINT_ZERO_AMP28()
      CALL PRINT_ZERO_AMP29()
      CALL PRINT_ZERO_AMP30()
      CALL PRINT_ZERO_AMP31()
      CALL PRINT_ZERO_AMP32()
      CALL PRINT_ZERO_AMP33()
      CALL PRINT_ZERO_AMP34()
      RETURN
      END
