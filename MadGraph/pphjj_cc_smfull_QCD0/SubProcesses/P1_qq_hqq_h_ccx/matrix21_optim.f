...
C     
      ...
      PARAMETER (NWAVEFUNCS=20, NCOLOR=1) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,2))  !  count 1
      CALL OXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3))  !  count 1
      CALL OXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4))  !  count 1
      ...
      CALL FFS4_3(W(1,7),W(1,5),GC_84,MDL_MH,FK_MDL_WH,W(1,9))  !  count 4
      CALL FFS4_3(W(1,7),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,10))  !  count 4
      CALL FFS4_3(W(1,8),W(1,5),GC_84,MDL_MH,FK_MDL_WH,W(1,11))  !  count 4
      CALL FFS4_3(W(1,8),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,12))  !  count 4
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,13))  !  count 1
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,14))  !  count 1
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,15))  !  count 1
      CALL IXXXXX(P(0,6),ZERO,-1,-1*IC(6),W(1,16))  !  count 1
      CALL FFV2_3_3(W(1,1),W(1,4),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,17))  !  count 8
      CALL FFV2_3_3(W(1,2),W(1,3),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,18))  !  count 8
