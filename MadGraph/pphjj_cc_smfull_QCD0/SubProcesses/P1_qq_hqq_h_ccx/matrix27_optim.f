...
C     ----------
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,15),W(1,3),GC_101,MDL_MW,ZERO,W(1,21))  !  count 4
      CALL FFV2_3(W(1,15),W(1,4),GC_101,MDL_MW,ZERO,W(1,22))  !  count 4
      CALL FFV2_3(W(1,16),W(1,3),GC_101,MDL_MW,ZERO,W(1,23))  !  count 4
      CALL FFV2_3(W(1,16),W(1,4),GC_101,MDL_MW,ZERO,W(1,24))  !  count 4
      CALL FFV2_3(W(1,1),W(1,13),GC_42,MDL_MW,ZERO,W(1,25))  !  count 4
      CALL FFV2_3(W(1,1),W(1,14),GC_42,MDL_MW,ZERO,W(1,26))  !  count 4
      CALL FFV2_3(W(1,2),W(1,13),GC_42,MDL_MW,ZERO,W(1,27))  !  count 4
      CALL FFV2_3(W(1,2),W(1,14),GC_42,MDL_MW,ZERO,W(1,28))  !  count 4
