...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,2),ZERO,+1,+1*IC(2),W(1,3))  !  count 3
      ...
      CALL FFS4_3(W(1,7),W(1,5),GC_84,MDL_MH,FK_MDL_WH,W(1,9))  !  count 8
      CALL FFS4_3(W(1,7),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,10))  !  count 8
      CALL FFS4_3(W(1,8),W(1,5),GC_84,MDL_MH,FK_MDL_WH,W(1,11))  !  count 8
      CALL FFS4_3(W(1,8),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,12))  !  count 8
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,13))  !  count 3
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,14))  !  count 3
      CALL OXXXXX(P(0,6),ZERO,+1,+1*IC(6),W(1,15))  !  count 3
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,16))  !  count 3
      CALL FFV2_5_3(W(1,1),W(1,13),GC_51,GC_58,MDL_MZ,ZERO,W(1,17))  !  count 8
      CALL FFV2_5_3(W(1,2),W(1,14),GC_51,GC_58,MDL_MZ,ZERO,W(1,18))  !  count 8
      CALL FFV2_3_3(W(1,3),W(1,15),GC_50,GC_58,MDL_MZ,ZERO,W(1,19))  !  count 8
      CALL FFV2_3_3(W(1,4),W(1,16),GC_50,GC_58,MDL_MZ,ZERO,W(1,20))  !  count 8
      CALL VVS1P1N_3(W(1,17), W(1,19), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL VVS1P1N_3(W(1,17), W(1,20), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/7,5,8,6/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL VVS1P1N_3(W(1,18), W(1,19), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/11,9,12,10/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL VVS1P1N_3(W(1,18), W(1,20), GC_81, TMP(1))
      call CombineAmpS(4, 
     &(/15,13,16,14/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,15),GC_101,MDL_MW,ZERO,W(1,21))  !  count 4
      CALL FFV2_3(W(1,1),W(1,16),GC_101,MDL_MW,ZERO,W(1,22))  !  count 4
      CALL FFV2_3(W(1,2),W(1,15),GC_101,MDL_MW,ZERO,W(1,23))  !  count 4
      CALL FFV2_3(W(1,2),W(1,16),GC_101,MDL_MW,ZERO,W(1,24))  !  count 4
      CALL FFV2_3(W(1,3),W(1,13),GC_42,MDL_MW,ZERO,W(1,25))  !  count 4
      CALL FFV2_3(W(1,3),W(1,14),GC_42,MDL_MW,ZERO,W(1,26))  !  count 4
      CALL FFV2_3(W(1,4),W(1,13),GC_42,MDL_MW,ZERO,W(1,27))  !  count 4
      CALL FFV2_3(W(1,4),W(1,14),GC_42,MDL_MW,ZERO,W(1,28))  !  count 4
      CALL VVS1_0(W(1,21),W(1,25),W(1,9),GC_72,AMP(3,2))
      CALL VVS1_0(W(1,21),W(1,25),W(1,10),GC_72,AMP(1,2))
      CALL VVS1_0(W(1,21),W(1,25),W(1,11),GC_72,AMP(4,2))
      CALL VVS1_0(W(1,21),W(1,25),W(1,12),GC_72,AMP(2,2))
      CALL VVS1_0(W(1,22),W(1,27),W(1,9),GC_72,AMP(7,2))
      CALL VVS1_0(W(1,22),W(1,27),W(1,10),GC_72,AMP(5,2))
      CALL VVS1_0(W(1,22),W(1,27),W(1,11),GC_72,AMP(8,2))
      CALL VVS1_0(W(1,22),W(1,27),W(1,12),GC_72,AMP(6,2))
      CALL VVS1_0(W(1,23),W(1,26),W(1,9),GC_72,AMP(11,2))
      CALL VVS1_0(W(1,23),W(1,26),W(1,10),GC_72,AMP(9,2))
      CALL VVS1_0(W(1,23),W(1,26),W(1,11),GC_72,AMP(12,2))
      CALL VVS1_0(W(1,23),W(1,26),W(1,12),GC_72,AMP(10,2))
      CALL VVS1_0(W(1,24),W(1,28),W(1,9),GC_72,AMP(15,2))
      CALL VVS1_0(W(1,24),W(1,28),W(1,10),GC_72,AMP(13,2))
      CALL VVS1_0(W(1,24),W(1,28),W(1,11),GC_72,AMP(16,2))
      CALL VVS1_0(W(1,24),W(1,28),W(1,12),GC_72,AMP(14,2))  !  count 1
