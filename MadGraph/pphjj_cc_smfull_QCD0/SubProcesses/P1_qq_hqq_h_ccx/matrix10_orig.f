...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3_3(W(1,3),W(1,4),GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,6),W(1,7),W(1,5),GC_81,AMP(1))
      CALL FFV2_3(W(1,1),W(1,4),GC_101,MDL_MW, ZERO,W(1,7))
      CALL FFV2_3(W(1,3),W(1,2),GC_42,MDL_MW, ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,7),W(1,4),W(1,5),GC_72,AMP(2))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(1)
      JAMP(2,1) = (-1.000000000000000D+00)*AMP(2)
