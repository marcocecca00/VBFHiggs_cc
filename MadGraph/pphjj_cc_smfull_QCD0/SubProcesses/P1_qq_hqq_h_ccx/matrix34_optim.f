...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL OXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2))  !  count 1
      ...
      CALL IXXXXX(P(0,5),ZERO,+1,-1*IC(5),W(1,13))  !  count 1
      CALL IXXXXX(P(0,5),ZERO,-1,-1*IC(5),W(1,14))  !  count 1
      ...
      CALL FFV2_3_3(W(1,14),W(1,2),GC_50,GC_58,MDL_MZ,ZERO,W(1,18))  !  count 8
