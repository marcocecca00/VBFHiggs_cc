...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3_3(W(1,3),W(1,2),GC_50,GC_58,MDL_MZ, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,6),W(1,7),W(1,5),GC_81,AMP(1))
      CALL FFV2_3(W(1,4),W(1,2),GC_101,MDL_MW, ZERO,W(1,7))
      CALL FFV2_3(W(1,3),W(1,1),GC_42,MDL_MW, ZERO,W(1,4))
