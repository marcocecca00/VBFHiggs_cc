...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,13))  !  count 10
      CALL FFV2_3(W(1,1),W(1,2),GC_101,MDL_MW,FK_MDL_WW,W(1,14))  !  count 16
      CALL FFV2_3(W(1,13),W(1,11),GC_44,MDL_MW,FK_MDL_WW,W(1,15))  !  count 4
      CALL FFV2_3(W(1,13),W(1,12),GC_44,MDL_MW,FK_MDL_WW,W(1,16))  !  count 4
      CALL VVS1P1N_3(W(1,14), W(1,15), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/6,2,8,4/), 
     & (/7,8,9,10/), 
     & TMP, W, AMP(1,1))
      CALL VVS1P1N_3(W(1,14), W(1,16), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/5,1,7,3/), 
     & (/7,8,9,10/), 
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFS4_1(W(1,11),W(1,7),GC_84,MDL_MC,FK_ZERO,W(1,17))  !  count 1
      CALL FFS4_1(W(1,11),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,18))  !  count 1
      CALL FFS4_1(W(1,11),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,19))  !  count 1
      CALL FFS4_1(W(1,11),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,20))  !  count 1
      CALL FFS4_1(W(1,12),W(1,7),GC_84,MDL_MC,FK_ZERO,W(1,21))  !  count 1
      CALL FFS4_1(W(1,12),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,22))  !  count 1
      CALL FFS4_1(W(1,12),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,23))  !  count 1
      CALL FFS4_1(W(1,12),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,24))  !  count 1
      CALL FFV2P1N_2(W(1,13), W(1,14), GC_44, TMP(1))
      call CombineAmp(8,
     & (/6,2,8,4,5,1,7,3/), 
