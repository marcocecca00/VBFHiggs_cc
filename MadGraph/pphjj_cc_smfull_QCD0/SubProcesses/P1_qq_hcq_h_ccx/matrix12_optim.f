...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,1),W(1,11),GC_45,MDL_MW,ZERO,W(1,15))  !  count 4
      CALL FFV2_3(W(1,1),W(1,12),GC_45,MDL_MW,ZERO,W(1,16))  !  count 4
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV2P1N_2(W(1,1), W(1,14), GC_45, TMP(1))
      call CombineAmp(8,
     & (/6,2,8,4,5,1,7,3/), 
