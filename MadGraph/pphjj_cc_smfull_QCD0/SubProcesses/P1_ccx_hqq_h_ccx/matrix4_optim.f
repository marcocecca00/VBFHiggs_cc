...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,14),W(1,3),GC_44,MDL_MW,ZERO,W(1,23))  !  count 16
      CALL FFV2_3(W(1,14),W(1,4),GC_44,MDL_MW,ZERO,W(1,24))  !  count 12
      CALL FFV2P1N_1(W(1,13), W(1,23), GC_104, TMP(1))
      call CombineAmp(8,
     & (/5,3,6,4,13,11,14,12/), 
     & (/15,16,17,18,19,20,21,22/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,13), W(1,24), GC_104, TMP(1))
      call CombineAmp(6,
     & (/2,1,9,7,10,8/), 
     & (/15,18,19,20,21,22/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,13),GC_104,MDL_MW,ZERO,W(1,25))  !  count 12
      CALL FFV2_3(W(1,2),W(1,13),GC_104,MDL_MW,ZERO,W(1,26))  !  count 16
