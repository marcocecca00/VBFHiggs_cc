...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,4))  !  count 5
      ...
      CALL FFS4_3(W(1,7),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,10))  !  count 7
      CALL FFS4_3(W(1,8),W(1,5),GC_84,MDL_MH,FK_MDL_WH,W(1,11))  !  count 7
      CALL FFS4_3(W(1,8),W(1,6),GC_84,MDL_MH,FK_MDL_WH,W(1,12))  !  count 8
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,13))  !  count 16
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,14))  !  count 16
      CALL FFS4_2(W(1,1),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,15))  !  count 2
      CALL FFS4_2(W(1,1),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,16))  !  count 1
      CALL FFS4_2(W(1,1),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,17))  !  count 1
      CALL FFS4_2(W(1,1),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,18))  !  count 2
      CALL FFS4_2(W(1,2),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,19))  !  count 2
      CALL FFS4_2(W(1,2),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,20))  !  count 2
      CALL FFS4_2(W(1,2),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,21))  !  count 2
      CALL FFS4_2(W(1,2),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,22))  !  count 2
      CALL FFV2_3(W(1,14),W(1,3),GC_45,MDL_MW,ZERO,W(1,23))  !  count 16
      CALL FFV2_3(W(1,14),W(1,4),GC_45,MDL_MW,ZERO,W(1,24))  !  count 12
      CALL FFV2P1N_1(W(1,13), W(1,23), GC_103, TMP(1))
      call CombineAmp(8,
     & (/5,3,6,4,13,11,14,12/), 
     & (/15,16,17,18,19,20,21,22/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,13), W(1,24), GC_103, TMP(1))
      call CombineAmp(6,
     & (/2,1,9,7,10,8/), 
     & (/15,18,19,20,21,22/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,13),GC_103,MDL_MW,ZERO,W(1,25))  !  count 12
      CALL FFV2_3(W(1,2),W(1,13),GC_103,MDL_MW,ZERO,W(1,26))  !  count 16
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS4_1(W(1,3),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,27))  !  count 2
      CALL FFS4_1(W(1,3),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,28))  !  count 2
      CALL FFS4_1(W(1,3),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,29))  !  count 2
      CALL FFS4_1(W(1,3),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,30))  !  count 2
      CALL FFS4_1(W(1,4),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,31))  !  count 2
      CALL FFS4_1(W(1,4),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,32))  !  count 1
      CALL FFS4_1(W(1,4),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,33))  !  count 1
      CALL FFS4_1(W(1,4),W(1,12),GC_84,MDL_MC,FK_ZERO,W(1,34))  !  count 2
