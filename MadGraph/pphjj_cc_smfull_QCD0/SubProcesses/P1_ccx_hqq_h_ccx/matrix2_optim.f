...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,15))  !  count 20
      CALL IXXXXX(P(0,6),ZERO,-1,-1*IC(6),W(1,16))  !  count 20
      ...
      CALL FFV2_3(W(1,15),W(1,3),GC_44,MDL_MW,ZERO,W(1,25))  !  count 16
      CALL FFV2_3(W(1,15),W(1,4),GC_44,MDL_MW,ZERO,W(1,26))  !  count 16
      CALL FFV2_3(W(1,16),W(1,3),GC_44,MDL_MW,ZERO,W(1,27))  !  count 16
      CALL FFV2_3(W(1,16),W(1,4),GC_44,MDL_MW,ZERO,W(1,28))  !  count 16
      CALL FFV2P1N_1(W(1,13), W(1,27), GC_103, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,30,26,32,28/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,13), W(1,28), GC_103, TMP(1))
      call CombineAmp(8,
     & (/6,2,8,4,22,18,24,20/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,14), W(1,25), GC_103, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,29,25,31,27/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,14), W(1,26), GC_103, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,21,17,23,19/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,15),W(1,14),GC_1,ZERO,FK_ZERO,W(1,29))  !  count 32
      CALL FFV1P0_3(W(1,16),W(1,13),GC_1,ZERO,FK_ZERO,W(1,30))  !  count 32
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3_3(W(1,15),W(1,14),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,31)
     $)  !  count 48
      CALL FFV2_3_3(W(1,16),W(1,13),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,32)
     $)  !  count 48
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,3),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,33))  !  count 8
      CALL FFV2_5_3(W(1,1),W(1,4),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,34))  !  count 8
      CALL FFV2_5_3(W(1,2),W(1,3),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,35))  !  count 8
      CALL FFV2_5_3(W(1,2),W(1,4),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,36))  !  count 8
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3(W(1,1),W(1,13),GC_103,MDL_MW,ZERO,W(1,37))  !  count 16
      CALL FFV2_3(W(1,1),W(1,14),GC_103,MDL_MW,ZERO,W(1,38))  !  count 16
      CALL FFV2_3(W(1,2),W(1,13),GC_103,MDL_MW,ZERO,W(1,39))  !  count 16
      CALL FFV2_3(W(1,2),W(1,14),GC_103,MDL_MW,ZERO,W(1,40))  !  count 16
     ...
     & TMP, W, AMP(1,5))  !  count 1
      ...
      CALL FFV2P1N_2(W(1,15), W(1,38), GC_44, TMP(1))
      call CombineAmp(8,
     & (/13,9,15,11,5,1,7,3/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,15), W(1,40), GC_44, TMP(1))
      call CombineAmp(8,
     & (/29,25,31,27,21,17,23,19/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,16), W(1,37), GC_44, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,6,2,8,4/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,16), W(1,39), GC_44, TMP(1))
      call CombineAmp(8,
