...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,14),W(1,1),GC_45,MDL_MW,ZERO,W(1,23))  !  count 16
      CALL FFV2_3(W(1,14),W(1,2),GC_45,MDL_MW,ZERO,W(1,24))  !  count 12
      CALL FFV2P1N_1(W(1,3), W(1,23), GC_103, TMP(1))
      call CombineAmp(8,
     & (/11,7,13,9,12,8,14,10/), 
     & (/15,16,17,18,19,20,21,22/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,3), W(1,24), GC_103, TMP(1))
      call CombineAmp(6,
     & (/4,1,6,2,5,3/), 
     & (/15,16,17,18,19,22/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,12),W(1,3),GC_103,MDL_MW,ZERO,W(1,25))  !  count 16
      CALL FFV2_3(W(1,13),W(1,3),GC_103,MDL_MW,ZERO,W(1,26))  !  count 12
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV2P1N_2(W(1,14), W(1,25), GC_45, TMP(1))
      call CombineAmp(8,
     & (/11,7,13,9,4,1,6,2/), 
     & (/27,28,29,30,31,32,33,34/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_2(W(1,14), W(1,26), GC_45, TMP(1))
      call CombineAmp(6,
     & (/12,8,14,10,5,3/), 
     & (/27,28,29,30,31,34/),
