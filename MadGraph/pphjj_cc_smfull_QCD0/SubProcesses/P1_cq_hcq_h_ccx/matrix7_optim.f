...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,14),W(1,12),GC_45,MDL_MW,FK_MDL_WW,W(1,23))  !  count 12
      CALL FFV2_3(W(1,14),W(1,13),GC_45,MDL_MW,FK_MDL_WW,W(1,24))  !  count 16
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,3),GC_103,MDL_MW,FK_MDL_WW,W(1,25))  !  count 12
      CALL FFV2_3(W(1,2),W(1,3),GC_103,MDL_MW,FK_MDL_WW,W(1,26))  !  count 16
