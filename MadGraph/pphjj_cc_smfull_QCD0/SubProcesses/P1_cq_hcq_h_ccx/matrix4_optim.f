...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_3(W(1,3),W(1,13),GC_45,MDL_MW,ZERO,W(1,25))  !  count 16
      CALL FFV2_3(W(1,3),W(1,14),GC_45,MDL_MW,ZERO,W(1,26))  !  count 16
      CALL FFV2_3(W(1,4),W(1,13),GC_45,MDL_MW,ZERO,W(1,27))  !  count 16
      CALL FFV2_3(W(1,4),W(1,14),GC_45,MDL_MW,ZERO,W(1,28))  !  count 16
      CALL FFV2P1N_1(W(1,15), W(1,25), GC_104, TMP(1))
      call CombineAmp(8,
     & (/6,2,8,4,22,18,24,20/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,15), W(1,26), GC_104, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,21,17,23,19/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,16), W(1,27), GC_104, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,30,26,32,28/), 
     & (/17,18,19,20,21,22,23,24/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,16), W(1,28), GC_104, TMP(1))
      call CombineAmp(8,
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3(W(1,1),W(1,15),GC_104,MDL_MW,ZERO,W(1,37))  !  count 16
      CALL FFV2_3(W(1,1),W(1,16),GC_104,MDL_MW,ZERO,W(1,38))  !  count 16
      CALL FFV2_3(W(1,2),W(1,15),GC_104,MDL_MW,ZERO,W(1,39))  !  count 16
      CALL FFV2_3(W(1,2),W(1,16),GC_104,MDL_MW,ZERO,W(1,40))  !  count 16
     ...
     & TMP, W, AMP(1,5))  !  count 1
      ...
      CALL FFV2P1N_2(W(1,3), W(1,37), GC_45, TMP(1))
      call CombineAmp(8,
     & (/6,2,8,4,5,1,7,3/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,3), W(1,39), GC_45, TMP(1))
      call CombineAmp(8,
     & (/22,18,24,20,21,17,23,19/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,4), W(1,38), GC_45, TMP(1))
      call CombineAmp(8,
     & (/14,10,16,12,13,9,15,11/), 
     & (/41,42,43,44,45,46,47,48/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,4), W(1,40), GC_45, TMP(1))
      call CombineAmp(8,
