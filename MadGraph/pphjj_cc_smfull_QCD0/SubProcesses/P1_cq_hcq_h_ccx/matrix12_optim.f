...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),MDL_MC,+1,-1*IC(1),W(1,1))  !  count 5
      CALL OXXXXX(P(0,1),MDL_MC,-1,-1*IC(1),W(1,2))  !  count 5
      CALL OXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3))  !  count 16
      ...
      CALL IXXXXX(P(0,5),MDL_MC,+1,-1*IC(5),W(1,12))  !  count 5
      CALL IXXXXX(P(0,5),MDL_MC,-1,-1*IC(5),W(1,13))  !  count 5
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,14))  !  count 16
      CALL FFS4_2(W(1,12),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,15))  !  count 2
      CALL FFS4_2(W(1,12),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,16))  !  count 2
      CALL FFS4_2(W(1,12),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,17))  !  count 2
      CALL FFS4_2(W(1,12),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,18))  !  count 2
      CALL FFS4_2(W(1,13),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,19))  !  count 2
      CALL FFS4_2(W(1,13),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,20))  !  count 1
      CALL FFS4_2(W(1,13),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,21))  !  count 1
      CALL FFS4_2(W(1,13),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,22))  !  count 2
      CALL FFV2_3(W(1,14),W(1,1),GC_44,MDL_MW,ZERO,W(1,23))  !  count 16
      CALL FFV2_3(W(1,14),W(1,2),GC_44,MDL_MW,ZERO,W(1,24))  !  count 12
      CALL FFV2P1N_1(W(1,3), W(1,23), GC_104, TMP(1))
      call CombineAmp(8,
     & (/11,7,13,9,12,8,14,10/), 
     & (/15,16,17,18,19,20,21,22/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,3), W(1,24), GC_104, TMP(1))
      call CombineAmp(6,
     & (/4,1,6,2,5,3/), 
     & (/15,16,17,18,19,22/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,12),W(1,3),GC_104,MDL_MW,ZERO,W(1,25))  !  count 16
      CALL FFV2_3(W(1,13),W(1,3),GC_104,MDL_MW,ZERO,W(1,26))  !  count 12
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS4_1(W(1,1),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,27))  !  count 2
      CALL FFS4_1(W(1,1),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,28))  !  count 2
      CALL FFS4_1(W(1,1),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,29))  !  count 2
      CALL FFS4_1(W(1,1),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,30))  !  count 2
      CALL FFS4_1(W(1,2),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,31))  !  count 2
      CALL FFS4_1(W(1,2),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,32))  !  count 1
      CALL FFS4_1(W(1,2),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,33))  !  count 1
      CALL FFS4_1(W(1,2),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,34))  !  count 2
      CALL FFV2P1N_2(W(1,14), W(1,25), GC_44, TMP(1))
      call CombineAmp(8,
     & (/11,7,13,9,4,1,6,2/), 
     & (/27,28,29,30,31,32,33,34/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_2(W(1,14), W(1,26), GC_44, TMP(1))
      call CombineAmp(6,
     & (/12,8,14,10,5,3/), 
     & (/27,28,29,30,31,34/),
