...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFV2_3(W(1,3),W(1,4),GC_101,MDL_MW, FK_MDL_WW,W(1,6))
      CALL FFV2_3(W(1,1),W(1,2),GC_44,MDL_MW, FK_MDL_WW,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,6),W(1,3),W(1,5),GC_72,AMP(1))
      CALL FFS4_1(W(1,2),W(1,5),GC_84,MDL_MC, FK_ZERO,W(1,3))
