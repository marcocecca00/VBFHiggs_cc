...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,1),W(1,12),GC_101,MDL_MW,ZERO,W(1,14))  !  count 16
      CALL FFV2_3(W(1,13),W(1,2),GC_45,MDL_MW,ZERO,W(1,15))  !  count 4
      CALL FFV2_3(W(1,13),W(1,3),GC_45,MDL_MW,ZERO,W(1,16))  !  count 4
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFS4_1(W(1,2),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,17))  !  count 1
      CALL FFS4_1(W(1,2),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,18))  !  count 1
      CALL FFS4_1(W(1,2),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,19))  !  count 1
      CALL FFS4_1(W(1,2),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,20))  !  count 1
      CALL FFS4_1(W(1,3),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,21))  !  count 1
      CALL FFS4_1(W(1,3),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,22))  !  count 1
      CALL FFS4_1(W(1,3),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,23))  !  count 1
      CALL FFS4_1(W(1,3),W(1,11),GC_84,MDL_MC,FK_ZERO,W(1,24))  !  count 1
