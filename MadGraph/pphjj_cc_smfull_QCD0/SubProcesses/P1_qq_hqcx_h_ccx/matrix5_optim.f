...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,1))  !  count 1
      CALL OXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,2))  !  count 1
      ...
      CALL FFS4_3(W(1,5),W(1,3),GC_84,MDL_MH,FK_MDL_WH,W(1,7))  !  count 4
      CALL FFS4_3(W(1,5),W(1,4),GC_84,MDL_MH,FK_MDL_WH,W(1,8))  !  count 4
      CALL FFS4_3(W(1,6),W(1,3),GC_84,MDL_MH,FK_MDL_WH,W(1,9))  !  count 4
      CALL FFS4_3(W(1,6),W(1,4),GC_84,MDL_MH,FK_MDL_WH,W(1,10))  !  count 4
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,11))  !  count 10
      CALL IXXXXX(P(0,6),MDL_MC,+1,-1*IC(6),W(1,12))  !  count 5
      CALL IXXXXX(P(0,6),MDL_MC,-1,-1*IC(6),W(1,13))  !  count 5
      CALL FFS4_2(W(1,12),W(1,7),GC_84,MDL_MC,FK_ZERO,W(1,14))  !  count 1
      CALL FFS4_2(W(1,12),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,15))  !  count 1
      CALL FFS4_2(W(1,12),W(1,9),GC_84,MDL_MC,FK_ZERO,W(1,16))  !  count 1
      CALL FFS4_2(W(1,12),W(1,10),GC_84,MDL_MC,FK_ZERO,W(1,17))  !  count 1
      CALL FFS4_2(W(1,13),W(1,7),GC_84,MDL_MC,FK_ZERO,W(1,18))  !  count 1
      CALL FFS4_2(W(1,13),W(1,8),GC_84,MDL_MC,FK_ZERO,W(1,19))  !  count 1
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_42,MDL_MW,FK_MDL_WW,W(1,22))  !  count 16
      CALL FFV2P1N_1(W(1,11), W(1,22), GC_103, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,6,2,8,4/), 
     & (/14,15,16,17,18,19,20,21/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,12),W(1,11),GC_103,MDL_MW,FK_MDL_WW,W(1,23))  !  count 4
      CALL FFV2_3(W(1,13),W(1,11),GC_103,MDL_MW,FK_MDL_WW,W(1,24))  !  count 4
      CALL VVS1P1N_3(W(1,23), W(1,22), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/5,1,7,3/), 
     & (/7,8,9,10/), 
     & TMP, W, AMP(1,2))
      CALL VVS1P1N_3(W(1,24), W(1,22), GC_72, TMP(1))
      call CombineAmpS(4, 
     &(/6,2,8,4/), 
     & (/7,8,9,10/), 
