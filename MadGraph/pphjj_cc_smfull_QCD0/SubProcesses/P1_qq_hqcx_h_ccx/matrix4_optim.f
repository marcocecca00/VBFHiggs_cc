...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2P1N_1(W(1,2), W(1,22), GC_104, TMP(1))
      call CombineAmp(8,
     & (/5,1,7,3,6,2,8,4/), 
     & (/14,15,16,17,18,19,20,21/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,12),W(1,2),GC_104,MDL_MW,ZERO,W(1,23))  !  count 4
      CALL FFV2_3(W(1,13),W(1,2),GC_104,MDL_MW,ZERO,W(1,24))  !  count 4
