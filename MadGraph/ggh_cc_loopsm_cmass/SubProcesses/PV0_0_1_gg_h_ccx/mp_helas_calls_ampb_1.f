...
C      if true.
      ...
      CALL MP_OXXXXX(P(0,3),MDL_MC,NHEL(3),+1*IC(3),W(1,3))
      CALL MP_IXXXXX(P(0,4),MDL_MC,NHEL(4),-1*IC(4),W(1,4))
      CALL MP_FFS1_3(W(1,4),W(1,3),GC_34,MDL_MH,MDL_WH,W(1,5))
C     Counter-term amplitude(s) for loop diagram number 1
      CALL MP_VVS1_0(W(1,1),W(1,2),W(1,5),R2_GGHC,AMPL(1,1))
C     Counter-term amplitude(s) for loop diagram number 3
      CALL MP_VVS1_0(W(1,1),W(1,2),W(1,5),R2_GGHB,AMPL(1,2))
C     Counter-term amplitude(s) for loop diagram number 5
      CALL MP_VVS1_0(W(1,1),W(1,2),W(1,5),R2_GGHT,AMPL(1,3))
