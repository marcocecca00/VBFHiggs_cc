...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MC,+1,+1*IC(1),W(1,1))  !  count 11
      CALL IXXXXX(P(0,1),MDL_MC,-1,+1*IC(1),W(1,2))  !  count 11
      ...
      CALL IXXXXX(P(0,5),ZERO,+1,-1*IC(5),W(1,8))  !  count 2
      CALL IXXXXX(P(0,5),ZERO,-1,-1*IC(5),W(1,9))  !  count 2
      CALL FFV1P0_3(W(1,8),W(1,3),GC_2,ZERO,FK_ZERO,W(1,10))  !  count 8
      CALL FFV1P0_3(W(1,9),W(1,4),GC_2,ZERO,FK_ZERO,W(1,11))  !  count 8
      CALL FFS4_2(W(1,1),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,12))  !  count 8
      CALL FFS4_2(W(1,2),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,13))  !  count 8
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_3(W(1,8),W(1,3),GC_51,GC_58,MDL_MZ,ZERO,W(1,14))  !  count 12
      CALL FFV2_5_3(W(1,9),W(1,4),GC_51,GC_58,MDL_MZ,ZERO,W(1,15))  !  count 12
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,6),GC_51,GC_58,MDL_MZ,ZERO,W(1,16))  !  count 2
      CALL FFV2_5_3(W(1,1),W(1,7),GC_51,GC_58,MDL_MZ,ZERO,W(1,17))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,6),GC_51,GC_58,MDL_MZ,ZERO,W(1,18))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,7),GC_51,GC_58,MDL_MZ,ZERO,W(1,19))  !  count 2
