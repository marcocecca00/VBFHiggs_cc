...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,7),W(1,5),GC_45,MDL_MW,FK_MDL_WW,W(1,10))  !  count 4
      CALL FFV2_3(W(1,7),W(1,6),GC_45,MDL_MW,FK_MDL_WW,W(1,11))  !  count 4
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,3),GC_103,MDL_MW,FK_MDL_WW,W(1,12))  !  count 4
      CALL FFV2_3(W(1,2),W(1,3),GC_103,MDL_MW,FK_MDL_WW,W(1,13))  !  count 4
