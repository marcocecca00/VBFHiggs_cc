...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,5),W(1,2),GC_2,ZERO, FK_ZERO,W(1,6))
      CALL FFS4_2(W(1,1),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,4),W(1,6),GC_2,AMP(1))
      CALL FFV2_5_3(W(1,5),W(1,2),GC_51,GC_58,MDL_MZ, ZERO,W(1,8))
