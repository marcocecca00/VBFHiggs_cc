...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,5),W(1,4),GC_45,MDL_MW, FK_MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,6),W(1,2),W(1,7),GC_104,AMP(1))
      CALL FFV1P0_3(W(1,5),W(1,2),GC_1,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,4),W(1,8),GC_2,AMP(2))
      CALL FFV2_3_3(W(1,5),W(1,2),GC_50,GC_58,MDL_MZ, ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,6),W(1,4),W(1,9),GC_51,GC_58,AMP(3))
      CALL FFV2_5_3(W(1,1),W(1,4),GC_51,GC_58,MDL_MZ, ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL VVS1_0(W(1,6),W(1,9),W(1,3),GC_81,AMP(4))
      CALL FFV2_3(W(1,1),W(1,2),GC_104,MDL_MW, FK_MDL_WW,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL VVS1_0(W(1,6),W(1,7),W(1,3),GC_72,AMP(5))
      CALL FFS4_1(W(1,4),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,7),W(1,6),GC_45,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,1),W(1,7),W(1,8),GC_2,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,1),W(1,7),W(1,9),GC_51,GC_58,AMP(8))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = (-1.000000000000000D+00)*AMP(1)+(-1.000000000000000D
     $ +00)*AMP(5)+(-1.000000000000000D+00)*AMP(6)
      JAMP(2,1) = AMP(2)+AMP(3)+AMP(4)+AMP(7)+AMP(8)
