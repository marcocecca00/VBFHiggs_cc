...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_3(W(1,3),W(1,6),GC_44,MDL_MW,ZERO,W(1,12))  !  count 4
      CALL FFV2_3(W(1,3),W(1,7),GC_44,MDL_MW,ZERO,W(1,13))  !  count 4
      CALL FFV2_3(W(1,4),W(1,6),GC_44,MDL_MW,ZERO,W(1,14))  !  count 4
      CALL FFV2_3(W(1,4),W(1,7),GC_44,MDL_MW,ZERO,W(1,15))  !  count 4
      CALL FFV2P1N_3(W(1,10), W(1,8), GC_103, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,10), W(1,9), GC_103, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,11), W(1,8), GC_103, TMP(1))
      call CombineAmp(2,
     & (/6,5/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,11), W(1,9), GC_103, TMP(1))
      call CombineAmp(2,
     & (/8,7/), 
     & (/14,15/),
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3(W(1,1),W(1,8),GC_103,MDL_MW,ZERO,W(1,24))  !  count 4
      CALL FFV2_3(W(1,1),W(1,9),GC_103,MDL_MW,ZERO,W(1,25))  !  count 4
      CALL FFV2_3(W(1,2),W(1,8),GC_103,MDL_MW,ZERO,W(1,26))  !  count 4
      CALL FFV2_3(W(1,2),W(1,9),GC_103,MDL_MW,ZERO,W(1,27))  !  count 4
     ...
     & TMP, W, AMP(1,5))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,3), W(1,28), GC_44, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/24,26/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,3), W(1,29), GC_44, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/24,26/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,4), W(1,28), GC_44, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/25,27/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,4), W(1,29), GC_44, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/25,27/),
