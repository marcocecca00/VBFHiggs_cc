...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,5),W(1,4),GC_44,MDL_MW, FK_MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,6),W(1,2),W(1,7),GC_103,AMP(1))
