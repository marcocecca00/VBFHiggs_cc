...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,2),ZERO,+1,+1*IC(2),W(1,3))  !  count 8
      CALL IXXXXX(P(0,2),ZERO,-1,+1*IC(2),W(1,4))  !  count 8
      ...
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,8))  !  count 8
      ...
      CALL FFV2_3(W(1,3),W(1,6),GC_45,MDL_MW,ZERO,W(1,12))  !  count 4
      CALL FFV2_3(W(1,3),W(1,7),GC_45,MDL_MW,ZERO,W(1,13))  !  count 4
      CALL FFV2_3(W(1,4),W(1,6),GC_45,MDL_MW,ZERO,W(1,14))  !  count 4
      CALL FFV2_3(W(1,4),W(1,7),GC_45,MDL_MW,ZERO,W(1,15))  !  count 4
      CALL FFV2P1N_3(W(1,10), W(1,8), GC_104, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,10), W(1,9), GC_104, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,11), W(1,8), GC_104, TMP(1))
      call CombineAmp(2,
     & (/6,5/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,11), W(1,9), GC_104, TMP(1))
      call CombineAmp(2,
     & (/8,7/), 
     & (/14,15/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,3),W(1,8),GC_1,ZERO,FK_ZERO,W(1,16))  !  count 8
      CALL FFV1P0_3(W(1,4),W(1,9),GC_1,ZERO,FK_ZERO,W(1,17))  !  count 8
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3_3(W(1,3),W(1,8),GC_50,GC_58,MDL_MZ,ZERO,W(1,18))  !  count 12
      CALL FFV2_3_3(W(1,4),W(1,9),GC_50,GC_58,MDL_MZ,ZERO,W(1,19))  !  count 12
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3(W(1,1),W(1,8),GC_104,MDL_MW,ZERO,W(1,24))  !  count 4
      CALL FFV2_3(W(1,1),W(1,9),GC_104,MDL_MW,ZERO,W(1,25))  !  count 4
      CALL FFV2_3(W(1,2),W(1,8),GC_104,MDL_MW,ZERO,W(1,26))  !  count 4
      CALL FFV2_3(W(1,2),W(1,9),GC_104,MDL_MW,ZERO,W(1,27))  !  count 4
     ...
     & TMP, W, AMP(1,5))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,3), W(1,28), GC_45, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/24,26/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,3), W(1,29), GC_45, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/24,26/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,4), W(1,28), GC_45, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/25,27/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,4), W(1,29), GC_45, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/25,27/),
