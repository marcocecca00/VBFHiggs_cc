...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL OXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3))  !  count 8
      CALL OXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4))  !  count 8
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5))  !  count 20
      CALL OXXXXX(P(0,4),MDL_MC,+1,+1*IC(4),W(1,6))  !  count 13
      CALL OXXXXX(P(0,4),MDL_MC,-1,+1*IC(4),W(1,7))  !  count 13
      ...
      CALL FFV2_3(W(1,8),W(1,6),GC_44,MDL_MW,FK_MDL_WW,W(1,12))  !  count 4
      CALL FFV2_3(W(1,8),W(1,7),GC_44,MDL_MW,FK_MDL_WW,W(1,13))  !  count 4
      CALL FFV2_3(W(1,9),W(1,6),GC_44,MDL_MW,FK_MDL_WW,W(1,14))  !  count 4
      CALL FFV2_3(W(1,9),W(1,7),GC_44,MDL_MW,FK_MDL_WW,W(1,15))  !  count 4
      CALL FFV2P1N_3(W(1,10), W(1,3), GC_103, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,10), W(1,4), GC_103, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,11), W(1,3), GC_103, TMP(1))
      call CombineAmp(2,
     & (/8,7/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,11), W(1,4), GC_103, TMP(1))
      call CombineAmp(2,
     & (/6,5/), 
     & (/14,15/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,8),W(1,3),GC_1,ZERO,FK_ZERO,W(1,16))  !  count 8
      CALL FFV1P0_3(W(1,9),W(1,4),GC_1,ZERO,FK_ZERO,W(1,17))  !  count 8
      CALL FFV1P1N_1(W(1,6), W(1,16), GC_2, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/10,11/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,6), W(1,17), GC_2, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/10,11/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,7), W(1,16), GC_2, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/10,11/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,7), W(1,17), GC_2, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/10,11/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3_3(W(1,8),W(1,3),GC_50,GC_58,MDL_MZ,ZERO,W(1,18))  !  count 12
      CALL FFV2_3_3(W(1,9),W(1,4),GC_50,GC_58,MDL_MZ,ZERO,W(1,19))  !  count 12
      CALL FFV2_5P1N_1(W(1,6), W(1,18), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/10,11/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,6), W(1,19), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/10,11/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,7), W(1,18), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/10,11/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,7), W(1,19), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/10,11/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,6),GC_51,GC_58,MDL_MZ,ZERO,W(1,20))  !  count 2
      CALL FFV2_5_3(W(1,1),W(1,7),GC_51,GC_58,MDL_MZ,ZERO,W(1,21))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,6),GC_51,GC_58,MDL_MZ,ZERO,W(1,22))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,7),GC_51,GC_58,MDL_MZ,ZERO,W(1,23))  !  count 2
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3(W(1,1),W(1,3),GC_103,MDL_MW,FK_MDL_WW,W(1,24))  !  count 4
      CALL FFV2_3(W(1,1),W(1,4),GC_103,MDL_MW,FK_MDL_WW,W(1,25))  !  count 4
      CALL FFV2_3(W(1,2),W(1,3),GC_103,MDL_MW,FK_MDL_WW,W(1,26))  !  count 4
      CALL FFV2_3(W(1,2),W(1,4),GC_103,MDL_MW,FK_MDL_WW,W(1,27))  !  count 4
     ...
     & TMP, W, AMP(1,5))  !  count 1
      CALL FFS4_1(W(1,6),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,28))  !  count 12
      CALL FFS4_1(W(1,7),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,29))  !  count 12
...
C       JAMPs contributing to orders ALL_ORDERS=1
     ...
     $  00D +00)*AMP( K,5)+(-1.000000000000000D+00)*AMP( K,6)
        JAMP(2,1) = AMP( K,2)+AMP( K,3)+AMP( K,4)+AMP( K,7)+AMP( K,8)
