...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,7),W(1,3),GC_45,MDL_MW,ZERO,W(1,10))  !  count 4
      CALL FFV2_3(W(1,7),W(1,4),GC_45,MDL_MW,ZERO,W(1,11))  !  count 4
      CALL FFV2P1N_1(W(1,6), W(1,10), GC_103, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/8,9/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,6), W(1,11), GC_103, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/8,9/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,6),GC_103,MDL_MW,ZERO,W(1,12))  !  count 4
      CALL FFV2_3(W(1,2),W(1,6),GC_103,MDL_MW,ZERO,W(1,13))  !  count 4
