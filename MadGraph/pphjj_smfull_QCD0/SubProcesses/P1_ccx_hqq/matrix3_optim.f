...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV1P0_3(W(1,8),W(1,7),GC_2,ZERO,FK_ZERO,W(1,10))  !  count 8
      CALL FFV1P0_3(W(1,9),W(1,6),GC_2,ZERO,FK_ZERO,W(1,11))  !  count 8
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_3(W(1,8),W(1,7),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,14))  !  count 12
      CALL FFV2_5_3(W(1,9),W(1,6),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,15))  !  count 12
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,3),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,16))  !  count 2
      CALL FFV2_5_3(W(1,1),W(1,4),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,17))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,3),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,18))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,4),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,19))  !  count 2
