...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MC,+1,+1*IC(1),W(1,1))  !  count 13
      CALL IXXXXX(P(0,1),MDL_MC,-1,+1*IC(1),W(1,2))  !  count 13
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,3))  !  count 13
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,4))  !  count 13
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5))  !  count 20
      CALL OXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,6))  !  count 8
      CALL OXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,7))  !  count 8
      CALL IXXXXX(P(0,5),ZERO,+1,-1*IC(5),W(1,8))  !  count 8
      CALL IXXXXX(P(0,5),ZERO,-1,-1*IC(5),W(1,9))  !  count 8
      CALL FFS4_2(W(1,1),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,10))  !  count 12
      CALL FFS4_2(W(1,2),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,11))  !  count 12
      CALL FFV2_3(W(1,8),W(1,3),GC_44,MDL_MW,ZERO,W(1,12))  !  count 4
      CALL FFV2_3(W(1,8),W(1,4),GC_44,MDL_MW,ZERO,W(1,13))  !  count 4
      CALL FFV2_3(W(1,9),W(1,3),GC_44,MDL_MW,ZERO,W(1,14))  !  count 4
      CALL FFV2_3(W(1,9),W(1,4),GC_44,MDL_MW,ZERO,W(1,15))  !  count 4
      CALL FFV2P1N_3(W(1,10), W(1,6), GC_103, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,10), W(1,7), GC_103, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,11), W(1,6), GC_103, TMP(1))
      call CombineAmp(2,
     & (/8,6/), 
     & (/14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,11), W(1,7), GC_103, TMP(1))
      call CombineAmp(2,
     & (/7,5/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,8),W(1,7),GC_1,ZERO,FK_ZERO,W(1,16))  !  count 8
      CALL FFV1P0_3(W(1,9),W(1,6),GC_1,ZERO,FK_ZERO,W(1,17))  !  count 8
      CALL FFV1P1N_1(W(1,3), W(1,16), GC_2, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/10,11/),
     & TMP, W, AMP(1,2))
     ...
     & (/10,11/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,4), W(1,16), GC_2, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/10,11/),
     & TMP, W, AMP(1,2))
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3_3(W(1,8),W(1,7),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,18))  !  count 12
      CALL FFV2_3_3(W(1,9),W(1,6),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,19))  !  count 12
      CALL FFV2_5P1N_1(W(1,3), W(1,18), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/10,11/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,3), W(1,19), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/10,11/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,4), W(1,18), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/10,11/),
     & TMP, W, AMP(1,3))
      CALL FFV2_5P1N_1(W(1,4), W(1,19), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/10,11/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,3),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,20))  !  count 2
      CALL FFV2_5_3(W(1,1),W(1,4),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,21))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,3),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,22))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,4),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,23))  !  count 2
      CALL VVS1P1N_1(W(1,18), W(1,5), GC_81, TMP(1))
      call CombineAmp(4,
     & (/3,1,7,5/), 
     & (/20,21,22,23/),
     & TMP, W, AMP(1,4))
      CALL VVS1P1N_1(W(1,19), W(1,5), GC_81, TMP(1))
      call CombineAmp(4,
     & (/4,2,8,6/), 
     & (/20,21,22,23/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3(W(1,1),W(1,6),GC_103,MDL_MW,ZERO,W(1,24))  !  count 4
      CALL FFV2_3(W(1,1),W(1,7),GC_103,MDL_MW,ZERO,W(1,25))  !  count 4
      CALL FFV2_3(W(1,2),W(1,6),GC_103,MDL_MW,ZERO,W(1,26))  !  count 4
      CALL FFV2_3(W(1,2),W(1,7),GC_103,MDL_MW,ZERO,W(1,27))  !  count 4
      CALL VVS1P1N_1(W(1,14), W(1,5), GC_72, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/24,26/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,15), W(1,5), GC_72, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/24,26/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,12), W(1,5), GC_72, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/25,27/),
     & TMP, W, AMP(1,5))
      CALL VVS1P1N_1(W(1,13), W(1,5), GC_72, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/25,27/),
     & TMP, W, AMP(1,5))  !  count 1
      CALL FFS4_1(W(1,3),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,28))  !  count 12
      CALL FFS4_1(W(1,4),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,29))  !  count 12
      CALL FFV2P1N_3(W(1,8), W(1,28), GC_44, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/25,27/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,8), W(1,29), GC_44, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/25,27/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,9), W(1,28), GC_44, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/24,26/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,9), W(1,29), GC_44, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/24,26/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1P1N_1(W(1,28), W(1,16), GC_2, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/1,2/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,28), W(1,17), GC_2, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/1,2/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,29), W(1,16), GC_2, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/1,2/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,29), W(1,17), GC_2, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/1,2/),
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV2_5P1N_1(W(1,28), W(1,18), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/1,2/),
     & TMP, W, AMP(1,8))
      CALL FFV2_5P1N_1(W(1,28), W(1,19), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/1,2/),
     & TMP, W, AMP(1,8))
      CALL FFV2_5P1N_1(W(1,29), W(1,18), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/1,2/),
     & TMP, W, AMP(1,8))
      CALL FFV2_5P1N_1(W(1,29), W(1,19), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/1,2/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
     ...
     $  00D+00)*AMP( K,7)+(-1.000000000000000D+00)*AMP( K,8)
        JAMP(2,1) = AMP( K,1)+AMP( K,5)+AMP( K,6)
