...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,2),MDL_MC,+1,+1*IC(2),W(1,3))  !  count 11
      CALL IXXXXX(P(0,2),MDL_MC,-1,+1*IC(2),W(1,4))  !  count 11
      ...
      CALL OXXXXX(P(0,5),MDL_MC,+1,+1*IC(5),W(1,8))  !  count 11
      CALL OXXXXX(P(0,5),MDL_MC,-1,+1*IC(5),W(1,9))  !  count 11
      CALL FFV1P0_3(W(1,1),W(1,6),GC_2,ZERO,FK_ZERO,W(1,10))  !  count 8
      CALL FFV1P0_3(W(1,2),W(1,7),GC_2,ZERO,FK_ZERO,W(1,11))  !  count 8
      CALL FFS4_2(W(1,3),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,12))  !  count 8
      CALL FFS4_2(W(1,4),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,13))  !  count 8
      CALL FFV1P1N_1(W(1,8), W(1,10), GC_2, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,8), W(1,11), GC_2, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,9), W(1,10), GC_2, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,9), W(1,11), GC_2, TMP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/12,13/),
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV2_5P1N_1(W(1,8), W(1,14), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/12,13/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,8), W(1,15), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/12,13/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,9), W(1,14), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/12,13/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,9), W(1,15), GC_51, GC_58, TMP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/12,13/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_3(W(1,3),W(1,8),GC_51,GC_58,MDL_MZ,ZERO,W(1,16))  !  count 2
      CALL FFV2_5_3(W(1,3),W(1,9),GC_51,GC_58,MDL_MZ,ZERO,W(1,17))  !  count 2
      CALL FFV2_5_3(W(1,4),W(1,8),GC_51,GC_58,MDL_MZ,ZERO,W(1,18))  !  count 2
      CALL FFV2_5_3(W(1,4),W(1,9),GC_51,GC_58,MDL_MZ,ZERO,W(1,19))  !  count 2
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFS4_1(W(1,8),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,20))  !  count 8
      CALL FFS4_1(W(1,9),W(1,5),GC_84,MDL_MC,FK_ZERO,W(1,21))  !  count 8
