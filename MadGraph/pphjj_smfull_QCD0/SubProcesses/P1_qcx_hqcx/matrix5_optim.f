...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,6))  !  count 2
      CALL IXXXXX(P(0,4),ZERO,-1,-1*IC(4),W(1,7))  !  count 2
      CALL IXXXXX(P(0,5),MDL_MC,+1,-1*IC(5),W(1,8))  !  count 11
      CALL IXXXXX(P(0,5),MDL_MC,-1,-1*IC(5),W(1,9))  !  count 11
      CALL FFV1P0_3(W(1,6),W(1,1),GC_2,ZERO,FK_ZERO,W(1,10))  !  count 8
      CALL FFV1P0_3(W(1,7),W(1,2),GC_2,ZERO,FK_ZERO,W(1,11))  !  count 8
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_3(W(1,6),W(1,1),GC_51,GC_58,MDL_MZ,ZERO,W(1,14))  !  count 12
      CALL FFV2_5_3(W(1,7),W(1,2),GC_51,GC_58,MDL_MZ,ZERO,W(1,15))  !  count 12
