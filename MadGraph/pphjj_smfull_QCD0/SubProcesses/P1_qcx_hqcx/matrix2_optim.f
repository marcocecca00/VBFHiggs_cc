...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_3(W(1,1),W(1,3),GC_45,MDL_MW,FK_MDL_WW,W(1,12))  !  count 4
      CALL FFV2_3(W(1,1),W(1,4),GC_45,MDL_MW,FK_MDL_WW,W(1,13))  !  count 4
      CALL FFV2_3(W(1,2),W(1,3),GC_45,MDL_MW,FK_MDL_WW,W(1,14))  !  count 4
      CALL FFV2_3(W(1,2),W(1,4),GC_45,MDL_MW,FK_MDL_WW,W(1,15))  !  count 4
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3(W(1,8),W(1,6),GC_104,MDL_MW,FK_MDL_WW,W(1,24))  !  count 4
      CALL FFV2_3(W(1,8),W(1,7),GC_104,MDL_MW,FK_MDL_WW,W(1,25))  !  count 4
      CALL FFV2_3(W(1,9),W(1,6),GC_104,MDL_MW,FK_MDL_WW,W(1,26))  !  count 4
      CALL FFV2_3(W(1,9),W(1,7),GC_104,MDL_MW,FK_MDL_WW,W(1,27))  !  count 4
     ...
     & TMP, W, AMP(1,5))  !  count 1
      ...
      CALL FFV2P1N_3(W(1,1), W(1,28), GC_45, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/24,26/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,1), W(1,29), GC_45, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/24,26/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,2), W(1,28), GC_45, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/25,27/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_3(W(1,2), W(1,29), GC_45, TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/25,27/),
