...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,1))  !  count 6
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,2))  !  count 2
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,3))  !  count 2
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,4))  !  count 8
      CALL OXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,5))  !  count 6
      CALL IXXXXX(P(0,5),MDL_MC,+1,-1*IC(5),W(1,6))  !  count 2
      CALL IXXXXX(P(0,5),MDL_MC,-1,-1*IC(5),W(1,7))  !  count 2
      CALL FFS4_2(W(1,6),W(1,4),GC_84,MDL_MC,FK_ZERO,W(1,8))  !  count 2
      CALL FFS4_2(W(1,7),W(1,4),GC_84,MDL_MC,FK_ZERO,W(1,9))  !  count 2
      CALL FFV2_3(W(1,1),W(1,2),GC_44,MDL_MW,FK_MDL_WW,W(1,10))  !  count 4
      CALL FFV2_3(W(1,1),W(1,3),GC_44,MDL_MW,FK_MDL_WW,W(1,11))  !  count 4
      CALL FFV2P1N_1(W(1,5), W(1,10), GC_104, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/8,9/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,5), W(1,11), GC_104, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/8,9/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,6),W(1,5),GC_104,MDL_MW,FK_MDL_WW,W(1,12))  !  count 4
      CALL FFV2_3(W(1,7),W(1,5),GC_104,MDL_MW,FK_MDL_WW,W(1,13))  !  count 4
      CALL VVS1P1N_1(W(1,10), W(1,4), GC_72, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/12,13/),
     & TMP, W, AMP(1,2))
      CALL VVS1P1N_1(W(1,11), W(1,4), GC_72, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/12,13/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS4_1(W(1,2),W(1,4),GC_84,MDL_MC,FK_ZERO,W(1,14))  !  count 2
      CALL FFS4_1(W(1,3),W(1,4),GC_84,MDL_MC,FK_ZERO,W(1,15))  !  count 2
      CALL FFV2P1N_2(W(1,1), W(1,12), GC_44, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/14,15/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_2(W(1,1), W(1,13), GC_44, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/14,15/),
