...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,5),W(1,2),GC_2,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,4),W(1,7),GC_2,AMP(1))
      CALL FFS4_3(W(1,5),W(1,2),GC_84,MDL_MH, ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFS4_0(W(1,6),W(1,4),W(1,8),GC_84,AMP(2))
      CALL FFV2_5_3(W(1,5),W(1,2),GC_51,GC_58,MDL_MZ, ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,6),W(1,4),W(1,9),GC_51,GC_58,AMP(3))
      CALL FFV1P0_3(W(1,5),W(1,4),GC_2,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,2),W(1,10),GC_2,AMP(4))
      CALL FFS4_3(W(1,5),W(1,4),GC_84,MDL_MH, FK_MDL_WH,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFS4_0(W(1,6),W(1,2),W(1,11),GC_84,AMP(5))
      CALL FFV2_5_3(W(1,5),W(1,4),GC_51,GC_58,MDL_MZ, FK_MDL_WZ,W(1,12)
     $ )
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,6),W(1,2),W(1,12),GC_51,GC_58,AMP(6))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_2,ZERO, FK_ZERO,W(1,6))
      CALL FFS4_2(W(1,5),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFS4_1(W(1,4),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,5),W(1,16),W(1,6),GC_2,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFS4_0(W(1,5),W(1,16),W(1,14),GC_84,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,5),W(1,16),W(1,15),GC_51,GC_58,AMP(14))
...
C     Amplitude(s) for diagram number 19
      ...
      CALL FFS4_1(W(1,2),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,5),W(1,13),W(1,15),GC_2,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFS4_0(W(1,5),W(1,13),W(1,14),GC_84,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_5_0(W(1,5),W(1,13),W(1,6),GC_51,GC_58,AMP(22))
