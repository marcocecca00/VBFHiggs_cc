...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL OXXXXX(P(0,4),MDL_MC,NHEL(4),+1*IC(4),W(1,4))
      CALL OXXXXX(P(0,5),MDL_MC,NHEL(5),+1*IC(5),W(1,5))
      CALL FFS4_2(W(1,1),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 2
      CALL FFS4_0(W(1,6),W(1,5),W(1,8),GC_84,AMP(2))
      CALL FFV2_5_3(W(1,2),W(1,4),GC_51,GC_58,MDL_MZ, ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,6),W(1,5),W(1,9),GC_51,GC_58,AMP(3))
      CALL FFV1P0_3(W(1,2),W(1,5),GC_2,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,4),W(1,10),GC_2,AMP(4))
      CALL FFS4_3(W(1,2),W(1,5),GC_84,MDL_MH, ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFS4_0(W(1,6),W(1,4),W(1,11),GC_84,AMP(5))
      CALL FFV2_5_3(W(1,2),W(1,5),GC_51,GC_58,MDL_MZ, ZERO,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,6),W(1,4),W(1,12),GC_51,GC_58,AMP(6))
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO, FK_ZERO,W(1,6))
      CALL FFS4_2(W(1,2),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,13),W(1,5),W(1,6),GC_2,AMP(7))
      CALL FFS4_3(W(1,1),W(1,4),GC_84,MDL_MH, ZERO,W(1,14))
C     Amplitude(s) for diagram number 8
      CALL FFS4_0(W(1,13),W(1,5),W(1,14),GC_84,AMP(8))
      CALL FFV2_5_3(W(1,1),W(1,4),GC_51,GC_58,MDL_MZ, ZERO,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,13),W(1,5),W(1,15),GC_51,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL SSS1_0(W(1,14),W(1,11),W(1,3),GC_69,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL VVS1_0(W(1,15),W(1,12),W(1,3),GC_81,AMP(11))
      CALL FFS4_1(W(1,5),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV1P0_3(W(1,1),W(1,5),GC_2,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,13),W(1,4),W(1,15),GC_2,AMP(15))
      CALL FFS4_3(W(1,1),W(1,5),GC_84,MDL_MH, ZERO,W(1,14))
C     Amplitude(s) for diagram number 16
      CALL FFS4_0(W(1,13),W(1,4),W(1,14),GC_84,AMP(16))
      CALL FFV2_5_3(W(1,1),W(1,5),GC_51,GC_58,MDL_MZ, ZERO,W(1,6))
C     Amplitude(s) for diagram number 17
      CALL FFV2_5_0(W(1,13),W(1,4),W(1,6),GC_51,GC_58,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL SSS1_0(W(1,14),W(1,8),W(1,3),GC_69,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVS1_0(W(1,6),W(1,9),W(1,3),GC_81,AMP(19))
      CALL FFS4_1(W(1,4),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,13))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.000000000000000D+00)*AMP(14)+(-1.000000000000000D+00)*AMP(26)
     $ +(-1.000000000000000D+00)*AMP(27)+(-1.000000000000000D+00)
     $ *AMP(28)
      JAMP(2,1) = AMP(1)+AMP(2)+AMP(3)+AMP(15)+AMP(16)+AMP(17)+AMP(18)
