...
C     ----------
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,8),W(1,6),GC_100,MDL_MW,FK_MDL_WW,W(1,14))  !  count 1
      CALL FFV2_3(W(1,8),W(1,7),GC_100,MDL_MW,FK_MDL_WW,W(1,15))  !  count 1
      CALL FFV2_3(W(1,9),W(1,6),GC_100,MDL_MW,FK_MDL_WW,W(1,16))  !  count 1
      CALL FFV2_3(W(1,9),W(1,7),GC_100,MDL_MW,FK_MDL_WW,W(1,17))  !  count 1
      CALL FFV2_3(W(1,1),W(1,3),GC_41,MDL_MW,FK_MDL_WW,W(1,18))  !  count 1
      CALL FFV2_3(W(1,1),W(1,4),GC_41,MDL_MW,FK_MDL_WW,W(1,19))  !  count 1
      CALL FFV2_3(W(1,2),W(1,3),GC_41,MDL_MW,FK_MDL_WW,W(1,20))  !  count 1
      CALL FFV2_3(W(1,2),W(1,4),GC_41,MDL_MW,FK_MDL_WW,W(1,21))  !  count 1
