...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,6))  !  count 3
      CALL IXXXXX(P(0,4),ZERO,-1,-1*IC(4),W(1,7))  !  count 3
      ...
      CALL FFV2_5_3(W(1,7),W(1,2),GC_51,GC_58,MDL_MZ,ZERO,W(1,11))  !  count 2
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,6),W(1,3),GC_101,MDL_MW,ZERO,W(1,14))  !  count 1
      CALL FFV2_3(W(1,6),W(1,4),GC_101,MDL_MW,ZERO,W(1,15))  !  count 1
      CALL FFV2_3(W(1,7),W(1,3),GC_101,MDL_MW,ZERO,W(1,16))  !  count 1
      CALL FFV2_3(W(1,7),W(1,4),GC_101,MDL_MW,ZERO,W(1,17))  !  count 1
      CALL FFV2_3(W(1,8),W(1,1),GC_42,MDL_MW,ZERO,W(1,18))  !  count 1
      CALL FFV2_3(W(1,8),W(1,2),GC_42,MDL_MW,ZERO,W(1,19))  !  count 1
      CALL FFV2_3(W(1,9),W(1,1),GC_42,MDL_MW,ZERO,W(1,20))  !  count 1
      CALL FFV2_3(W(1,9),W(1,2),GC_42,MDL_MW,ZERO,W(1,21))  !  count 1
      CALL VVS1_0(W(1,14),W(1,18),W(1,5),GC_72,AMP(4,2))
      CALL VVS1_0(W(1,15),W(1,20),W(1,5),GC_72,AMP(3,2))
      CALL VVS1_0(W(1,16),W(1,19),W(1,5),GC_72,AMP(2,2))
      CALL VVS1_0(W(1,17),W(1,21),W(1,5),GC_72,AMP(1,2))  !  count 1
