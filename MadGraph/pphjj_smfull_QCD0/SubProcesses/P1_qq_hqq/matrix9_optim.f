...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,8))  !  count 4
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,9))  !  count 4
      CALL FFV2_3_3(W(1,1),W(1,6),GC_50,GC_58,MDL_MZ,ZERO,W(1,10))  !  count 2
      CALL FFV2_3_3(W(1,1),W(1,7),GC_50,GC_58,MDL_MZ,ZERO,W(1,11))  !  count 1
      CALL FFV2_3_3(W(1,2),W(1,6),GC_50,GC_58,MDL_MZ,ZERO,W(1,12))  !  count 1
      CALL FFV2_3_3(W(1,2),W(1,7),GC_50,GC_58,MDL_MZ,ZERO,W(1,13))  !  count 2
      CALL FFV2_3_3(W(1,3),W(1,8),GC_50,GC_58,MDL_MZ,ZERO,W(1,14))  !  count 2
      CALL FFV2_3_3(W(1,3),W(1,9),GC_50,GC_58,MDL_MZ,ZERO,W(1,15))  !  count 1
      CALL FFV2_3_3(W(1,4),W(1,8),GC_50,GC_58,MDL_MZ,ZERO,W(1,16))  !  count 1
      CALL FFV2_3_3(W(1,4),W(1,9),GC_50,GC_58,MDL_MZ,ZERO,W(1,17))  !  count 2
     ...
     & TMP, W, AMP(1,1))
      ...
      CALL FFV2_3_3(W(1,1),W(1,8),GC_50,GC_58,MDL_MZ,ZERO,W(1,18))  !  count 2
      CALL FFV2_3_3(W(1,1),W(1,9),GC_50,GC_58,MDL_MZ,ZERO,W(1,19))  !  count 1
      CALL FFV2_3_3(W(1,2),W(1,8),GC_50,GC_58,MDL_MZ,ZERO,W(1,20))  !  count 1
      CALL FFV2_3_3(W(1,2),W(1,9),GC_50,GC_58,MDL_MZ,ZERO,W(1,21))  !  count 2
      CALL FFV2_3_3(W(1,3),W(1,6),GC_50,GC_58,MDL_MZ,ZERO,W(1,22))  !  count 2
      CALL FFV2_3_3(W(1,3),W(1,7),GC_50,GC_58,MDL_MZ,ZERO,W(1,23))  !  count 1
      CALL FFV2_3_3(W(1,4),W(1,6),GC_50,GC_58,MDL_MZ,ZERO,W(1,24))  !  count 1
      CALL FFV2_3_3(W(1,4),W(1,7),GC_50,GC_58,MDL_MZ,ZERO,W(1,25))  !  count 2
     ...
     & (/18,21/),
     & TMP, W, AMP(1,2))
      CALL VVS1_0(W(1,19),W(1,24),W(1,5),GC_81,AMP(3,2))
      CALL VVS1_0(W(1,20),W(1,23),W(1,5),GC_81,AMP(4,2))  !  count 1
