...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFS4_2(W(1,5),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_5_3(W(1,5),W(1,4),GC_51,GC_58,MDL_MZ, FK_MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL VVS1_0(W(1,6),W(1,9),W(1,3),GC_81,AMP(4))
      CALL FFV2_3(W(1,5),W(1,2),GC_104,MDL_MW, ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,5),W(1,7),W(1,8),GC_2,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,5),W(1,7),W(1,9),GC_51,GC_58,AMP(8))
