...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_3(W(1,1),W(1,6),GC_45,MDL_MW,ZERO,W(1,12))  !  count 4
      CALL FFV2_3(W(1,1),W(1,7),GC_45,MDL_MW,ZERO,W(1,13))  !  count 4
      CALL FFV2_3(W(1,2),W(1,6),GC_45,MDL_MW,ZERO,W(1,14))  !  count 4
      CALL FFV2_3(W(1,2),W(1,7),GC_45,MDL_MW,ZERO,W(1,15))  !  count 4
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_1,ZERO,FK_ZERO,W(1,16))  !  count 8
      CALL FFV1P0_3(W(1,2),W(1,3),GC_1,ZERO,FK_ZERO,W(1,17))  !  count 8
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3_3(W(1,1),W(1,4),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,18))  !  count 12
      CALL FFV2_3_3(W(1,2),W(1,3),GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,19))  !  count 12
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_3(W(1,8),W(1,6),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,20))  !  count 2
      CALL FFV2_5_3(W(1,8),W(1,7),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,21))  !  count 2
      CALL FFV2_5_3(W(1,9),W(1,6),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,22))  !  count 2
      CALL FFV2_5_3(W(1,9),W(1,7),GC_51,GC_58,MDL_MZ,FK_MDL_WZ,W(1,23))  !  count 2
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3(W(1,8),W(1,3),GC_104,MDL_MW,ZERO,W(1,24))  !  count 4
      CALL FFV2_3(W(1,8),W(1,4),GC_104,MDL_MW,ZERO,W(1,25))  !  count 4
      CALL FFV2_3(W(1,9),W(1,3),GC_104,MDL_MW,ZERO,W(1,26))  !  count 4
      CALL FFV2_3(W(1,9),W(1,4),GC_104,MDL_MW,ZERO,W(1,27))  !  count 4
