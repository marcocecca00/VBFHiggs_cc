...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,6),W(1,4),GC_45,MDL_MW,FK_MDL_WW,W(1,8))  !  count 1
      CALL FFV2_3(W(1,6),W(1,5),GC_45,MDL_MW,FK_MDL_WW,W(1,9))  !  count 1
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV2P1N_2(W(1,6), W(1,7), GC_45, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/10,11/),
