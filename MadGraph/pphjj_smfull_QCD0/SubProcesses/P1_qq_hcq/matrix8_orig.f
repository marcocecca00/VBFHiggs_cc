...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFV2_3(W(1,5),W(1,4),GC_45,MDL_MW, FK_MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,6),W(1,2),W(1,3),GC_72,AMP(1))
      CALL FFS4_1(W(1,4),W(1,3),GC_84,MDL_MC, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,2),W(1,6),GC_45,AMP(2))
