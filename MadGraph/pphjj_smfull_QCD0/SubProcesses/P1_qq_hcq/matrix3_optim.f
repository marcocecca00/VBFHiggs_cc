...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL IXXXXX(P(0,2),ZERO,-1,+1*IC(2),W(1,2))  !  count 4
      ...
      CALL FFV2_3(W(1,1),W(1,6),GC_100,MDL_MW,ZERO,W(1,7))  !  count 4
      CALL FFV2_3(W(1,2),W(1,4),GC_45,MDL_MW,ZERO,W(1,8))  !  count 1
      CALL FFV2_3(W(1,2),W(1,5),GC_45,MDL_MW,ZERO,W(1,9))  !  count 1
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV2P1N_2(W(1,2), W(1,7), GC_45, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/10,11/),
