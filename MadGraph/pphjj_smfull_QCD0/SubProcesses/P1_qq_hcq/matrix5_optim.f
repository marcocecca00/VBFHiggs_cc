...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL IXXXXX(P(0,5),ZERO,+1,-1*IC(5),W(1,6))  !  count 4
      CALL FFV2_3(W(1,1),W(1,2),GC_100,MDL_MW,FK_MDL_WW,W(1,7))  !  count 4
      CALL FFV2_3(W(1,6),W(1,4),GC_44,MDL_MW,FK_MDL_WW,W(1,8))  !  count 1
      CALL FFV2_3(W(1,6),W(1,5),GC_44,MDL_MW,FK_MDL_WW,W(1,9))  !  count 1
      CALL VVS1P1N_2(W(1,7), W(1,3), GC_72, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/8,9/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFS4_1(W(1,4),W(1,3),GC_84,MDL_MC,FK_ZERO,W(1,10))  !  count 1
      CALL FFS4_1(W(1,5),W(1,3),GC_84,MDL_MC,FK_ZERO,W(1,11))  !  count 1
      CALL FFV2P1N_2(W(1,6), W(1,7), GC_44, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/10,11/),
