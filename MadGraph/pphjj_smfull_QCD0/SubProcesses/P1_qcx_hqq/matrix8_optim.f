...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,6),W(1,5),GC_101,MDL_MW,FK_MDL_WW,W(1,7))  !  count 4
      CALL FFV2_3(W(1,1),W(1,2),GC_45,MDL_MW,FK_MDL_WW,W(1,8))  !  count 1
      CALL FFV2_3(W(1,1),W(1,3),GC_45,MDL_MW,FK_MDL_WW,W(1,9))  !  count 1
