...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_3(W(1,1),W(1,5),GC_101,MDL_MW,ZERO,W(1,7))  !  count 4
      CALL FFV2_3(W(1,6),W(1,2),GC_45,MDL_MW,ZERO,W(1,8))  !  count 1
      CALL FFV2_3(W(1,6),W(1,3),GC_45,MDL_MW,ZERO,W(1,9))  !  count 1
      CALL VVS1P1N_2(W(1,7), W(1,4), GC_72, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/8,9/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFS4_1(W(1,2),W(1,4),GC_84,MDL_MC,FK_ZERO,W(1,10))  !  count 1
      CALL FFS4_1(W(1,3),W(1,4),GC_84,MDL_MC,FK_ZERO,W(1,11))  !  count 1
