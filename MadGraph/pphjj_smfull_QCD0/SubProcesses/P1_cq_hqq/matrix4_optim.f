...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,6))  !  count 4
      CALL FFS4_2(W(1,1),W(1,4),GC_84,MDL_MC,FK_ZERO,W(1,7))  !  count 1
      CALL FFS4_2(W(1,2),W(1,4),GC_84,MDL_MC,FK_ZERO,W(1,8))  !  count 1
      CALL FFV2_3(W(1,3),W(1,5),GC_42,MDL_MW,ZERO,W(1,9))  !  count 4
      CALL FFV2P1N_1(W(1,6), W(1,9), GC_104, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,6),GC_104,MDL_MW,ZERO,W(1,10))  !  count 1
      CALL FFV2_3(W(1,2),W(1,6),GC_104,MDL_MW,ZERO,W(1,11))  !  count 1
