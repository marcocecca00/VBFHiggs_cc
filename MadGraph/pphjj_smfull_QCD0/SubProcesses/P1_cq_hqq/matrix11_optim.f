...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2P1N_1(W(1,3), W(1,9), GC_104, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,3),GC_104,MDL_MW,FK_MDL_WW,W(1,10))  !  count 1
      CALL FFV2_3(W(1,2),W(1,3),GC_104,MDL_MW,FK_MDL_WW,W(1,11))  !  count 1
